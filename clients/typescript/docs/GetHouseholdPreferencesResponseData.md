...
**eligibleForFinancialInsights** | **boolean** |  | [optional] [default to undefined]

## Example

```typescript
import { GetHouseholdPreferencesResponseData } from 'monarch-bridge-client';

const instance: GetHouseholdPreferencesResponseData = {
    id,
