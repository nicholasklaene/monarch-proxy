...
------------ | ------------- | ------------- | -------------
**data** | [**GetBudgetsResponseData**](GetBudgetsResponseData.md) |  | [default to undefined]

## Example

```typescript
import { BudgetsResponse } from 'monarch-bridge-client';

const instance: BudgetsResponse = {
    data,
};
```
