...
json = "{}"
# create an instance of UpdateHouseholdPreferencesRequest from a JSON string
update_household_preferences_request_instance = UpdateHouseholdPreferencesRequest.from_json(json)
# print the JSON string representation of the object
print(UpdateHouseholdPreferencesRequest.to_json())

# convert the object into a dict
update_household_preferences_request_dict = update_household_preferences_request_instance.to_dict()
# create an instance of UpdateHouseholdPreferencesRequest from a dict
update_household_preferences_request_from_dict = UpdateHouseholdPreferencesRequest.from_dict(update_household_preferences_request_dict)
```
