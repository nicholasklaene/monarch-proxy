...
/**
 * Monarch `Common_UpsertBusinessEntity` op wired as an opaque FreeForm pass-through. The
 ...
 */
object UpsertBusinessEntity : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_UpsertBusinessEntity"
