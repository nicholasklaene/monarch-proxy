...
/**
 * Long-tail wrapper for the `Common_GetDecagonLinkedCredentials` GraphQL operation.
 *
 ...
 */
object GetDecagonLinkedCredentials : LongTailOperation("Common_GetDecagonLinkedCredentials")
