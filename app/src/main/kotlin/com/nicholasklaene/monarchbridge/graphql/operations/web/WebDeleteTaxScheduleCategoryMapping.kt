...
/**
 * Web bundle screen-aggregate `Web_DeleteTaxScheduleCategoryMapping` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDeleteTaxScheduleCategoryMapping : MonarchOperation<WebDeleteTaxScheduleCategoryMapping.Input, Map<String, Any>> {
    override val operationName: String = "Web_DeleteTaxScheduleCategoryMapping"
