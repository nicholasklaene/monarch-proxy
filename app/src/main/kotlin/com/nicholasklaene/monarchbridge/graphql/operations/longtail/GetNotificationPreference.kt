...
/**
 * Long-tail wrapper for the `Common_GetNotificationPreference` GraphQL operation.
 *
 ...
 */
object GetNotificationPreference : LongTailOperation("Common_GetNotificationPreference")
