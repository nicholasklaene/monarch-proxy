...
/**
 * Web bundle screen-aggregate `Web_GoalsMapAccounts` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalsMapAccounts : MonarchOperation<WebGoalsMapAccounts.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalsMapAccounts"
