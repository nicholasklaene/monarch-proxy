...
/**
 * Web bundle screen-aggregate `Web_GetTrustAndWillSubscription` (query). Wired as opaque pass-through:
 ...
 */
object WebGetTrustAndWillSubscription : MonarchOperation<WebGetTrustAndWillSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetTrustAndWillSubscription"
