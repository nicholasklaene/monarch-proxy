...
/**
 * Web bundle screen-aggregate `Web_GetEventPopoverTransactions` (query). Wired as opaque pass-through:
 ...
 */
object WebGetEventPopoverTransactions : MonarchOperation<WebGetEventPopoverTransactions.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetEventPopoverTransactions"
