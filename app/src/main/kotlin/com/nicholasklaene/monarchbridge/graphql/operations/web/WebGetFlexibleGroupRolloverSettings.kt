...
/**
 * Web bundle screen-aggregate `Web_GetFlexibleGroupRolloverSettings` (query). Wired as opaque pass-through:
 ...
 */
object WebGetFlexibleGroupRolloverSettings : MonarchOperation<WebGetFlexibleGroupRolloverSettings.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetFlexibleGroupRolloverSettings"
