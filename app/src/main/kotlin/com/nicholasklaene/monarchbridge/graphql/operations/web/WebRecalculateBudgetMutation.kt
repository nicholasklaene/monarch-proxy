...
/**
 * Web bundle screen-aggregate `Web_RecalculateBudgetMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebRecalculateBudgetMutation : MonarchOperation<WebRecalculateBudgetMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_RecalculateBudgetMutation"
