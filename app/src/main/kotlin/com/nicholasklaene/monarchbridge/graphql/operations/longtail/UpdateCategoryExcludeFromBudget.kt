...
/**
 * Long-tail wrapper for the `Common_UpdateCategoryExcludeFromBudget` GraphQL operation.
 *
 ...
 */
object UpdateCategoryExcludeFromBudget : LongTailOperation("Common_UpdateCategoryExcludeFromBudget")
