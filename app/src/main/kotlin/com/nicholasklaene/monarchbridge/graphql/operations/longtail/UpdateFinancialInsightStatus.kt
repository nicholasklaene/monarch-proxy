...
/**
 * Long-tail wrapper for the `Common_UpdateFinancialInsightStatus` GraphQL operation.
 *
 ...
 */
object UpdateFinancialInsightStatus : LongTailOperation("Common_UpdateFinancialInsightStatus")
