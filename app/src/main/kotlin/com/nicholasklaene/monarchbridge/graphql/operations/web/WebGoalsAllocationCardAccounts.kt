...
/**
 * Web bundle screen-aggregate `Web_GoalsAllocationCardAccounts` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalsAllocationCardAccounts : MonarchOperation<WebGoalsAllocationCardAccounts.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalsAllocationCardAccounts"
