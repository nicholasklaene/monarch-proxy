...
/**
 * Monarch `Web_SaveForecastAccounts` op wired as an opaque FreeForm pass-through. The
 ...
 */
object SaveForecastAccounts : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_SaveForecastAccounts"
