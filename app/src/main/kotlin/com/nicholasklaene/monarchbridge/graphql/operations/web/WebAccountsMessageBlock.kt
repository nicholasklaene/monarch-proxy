...
/**
 * Web bundle screen-aggregate `Web_AccountsMessageBlock` (query). Wired as opaque pass-through:
 ...
 */
object WebAccountsMessageBlock : MonarchOperation<WebAccountsMessageBlock.Input, Map<String, Any>> {
    override val operationName: String = "Web_AccountsMessageBlock"
