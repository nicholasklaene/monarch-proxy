...
/**
 * Web bundle screen-aggregate `Web_SnapshotsForAccountCopyBalancePreview` (query). Wired as opaque pass-through:
 ...
 */
object WebSnapshotsForAccountCopyBalancePreview : MonarchOperation<WebSnapshotsForAccountCopyBalancePreview.Input, Map<String, Any>> {
    override val operationName: String = "Web_SnapshotsForAccountCopyBalancePreview"
