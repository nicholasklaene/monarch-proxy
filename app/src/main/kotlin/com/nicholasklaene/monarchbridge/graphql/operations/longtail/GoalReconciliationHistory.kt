...
/**
 * Long-tail wrapper for the `Common_GoalReconciliationHistory` GraphQL operation.
 *
 ...
 */
object GoalReconciliationHistory : LongTailOperation("Common_GoalReconciliationHistory")
