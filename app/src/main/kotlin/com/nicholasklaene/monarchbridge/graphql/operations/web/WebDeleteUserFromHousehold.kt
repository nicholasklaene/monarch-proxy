...
/**
 * Web bundle screen-aggregate `Web_DeleteUserFromHousehold` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDeleteUserFromHousehold : MonarchOperation<WebDeleteUserFromHousehold.Input, Map<String, Any>> {
    override val operationName: String = "Web_DeleteUserFromHousehold"
