...
/**
 * Web bundle screen-aggregate `Web_ResetAndSyncAccountMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebResetAndSyncAccountMutation : MonarchOperation<WebResetAndSyncAccountMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_ResetAndSyncAccountMutation"
