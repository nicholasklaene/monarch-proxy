...
/**
 * Long-tail wrapper for the `GetAggregatesGraphCategoryGroup` GraphQL operation.
 *
 ...
 */
object GetAggregatesGraphCategoryGroup : LongTailOperation("GetAggregatesGraphCategoryGroup")
