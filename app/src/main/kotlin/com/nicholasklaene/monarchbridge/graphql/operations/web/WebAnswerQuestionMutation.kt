...
/**
 * Web bundle screen-aggregate `Web_AnswerQuestionMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebAnswerQuestionMutation : MonarchOperation<WebAnswerQuestionMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_AnswerQuestionMutation"
