...
/**
 * Monarch `Web_SaveForecastPriorityRules` op wired as an opaque FreeForm pass-through. The
 ...
 */
object SaveForecastPriorityRules : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_SaveForecastPriorityRules"
