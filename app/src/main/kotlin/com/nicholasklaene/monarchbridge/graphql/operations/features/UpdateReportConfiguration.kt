...
/**
 * Monarch `Common_UpdateReportConfiguration` op wired as an opaque FreeForm pass-through. The
 ...
 */
object UpdateReportConfiguration : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_UpdateReportConfiguration"
