...
/**
 * Web bundle screen-aggregate `Web_GetFilteredAccounts` (query). Wired as opaque pass-through:
 ...
 */
object WebGetFilteredAccounts : MonarchOperation<WebGetFilteredAccounts.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetFilteredAccounts"
