...
/**
 * Web bundle screen-aggregate `Web_DisconnectDiscord` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDisconnectDiscord : MonarchOperation<WebDisconnectDiscord.Input, Map<String, Any>> {
    override val operationName: String = "Web_DisconnectDiscord"
