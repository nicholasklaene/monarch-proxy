...
/**
 * Long-tail wrapper for the `Common_RevokeHouseholdAccessGrant` GraphQL operation.
 *
 ...
 */
object RevokeHouseholdAccessGrant : LongTailOperation("Common_RevokeHouseholdAccessGrant")
