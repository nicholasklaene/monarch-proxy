...
/**
 * Web bundle screen-aggregate `Web_GetAccountTypes` (query). Wired as opaque pass-through:
 ...
 */
object WebGetAccountTypes : MonarchOperation<WebGetAccountTypes.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetAccountTypes"
