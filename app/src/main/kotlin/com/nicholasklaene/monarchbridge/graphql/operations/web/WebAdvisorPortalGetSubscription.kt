...
/**
 * Web bundle screen-aggregate `Web_AdvisorPortalGetSubscription` (query). Wired as opaque pass-through:
 ...
 */
object WebAdvisorPortalGetSubscription : MonarchOperation<WebAdvisorPortalGetSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_AdvisorPortalGetSubscription"
