...
/**
 * Monarch `Common_GetBusinessEntityFinancials` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetBusinessEntityFinancials : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_GetBusinessEntityFinancials"
