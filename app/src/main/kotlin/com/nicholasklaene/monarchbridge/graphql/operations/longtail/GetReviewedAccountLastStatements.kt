...
/**
 * Long-tail wrapper for the `Common_GetReviewedAccountLastStatements` GraphQL operation.
 *
 ...
 */
object GetReviewedAccountLastStatements : LongTailOperation("Common_GetReviewedAccountLastStatements")
