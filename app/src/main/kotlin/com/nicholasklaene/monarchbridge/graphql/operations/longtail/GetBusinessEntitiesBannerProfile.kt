...
/**
 * Long-tail wrapper for the `Common_GetBusinessEntitiesBannerProfile` GraphQL operation.
 *
 ...
 */
object GetBusinessEntitiesBannerProfile : LongTailOperation("Common_GetBusinessEntitiesBannerProfile")
