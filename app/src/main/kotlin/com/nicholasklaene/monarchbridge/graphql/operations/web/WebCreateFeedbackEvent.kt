...
/**
 * Web bundle screen-aggregate `Web_CreateFeedbackEvent` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateFeedbackEvent : MonarchOperation<WebCreateFeedbackEvent.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreateFeedbackEvent"
