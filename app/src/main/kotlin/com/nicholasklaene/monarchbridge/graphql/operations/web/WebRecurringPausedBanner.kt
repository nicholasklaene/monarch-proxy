...
/**
 * Web bundle screen-aggregate `Web_RecurringPausedBanner` (query). Wired as opaque pass-through:
 ...
 */
object WebRecurringPausedBanner : MonarchOperation<WebRecurringPausedBanner.Input, Map<String, Any>> {
    override val operationName: String = "Web_RecurringPausedBanner"
