...
/**
 * Web bundle screen-aggregate `Web_GetTransactionsSummaryCard` (query). Wired as opaque pass-through:
 ...
 */
object WebGetTransactionsSummaryCard : MonarchOperation<WebGetTransactionsSummaryCard.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetTransactionsSummaryCard"
