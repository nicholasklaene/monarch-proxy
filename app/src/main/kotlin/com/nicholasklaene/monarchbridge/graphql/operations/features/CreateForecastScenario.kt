...
/**
 * Monarch `Web_CreateForecastScenario` op wired as an opaque FreeForm pass-through. The
 ...
 */
object CreateForecastScenario : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_CreateForecastScenario"
