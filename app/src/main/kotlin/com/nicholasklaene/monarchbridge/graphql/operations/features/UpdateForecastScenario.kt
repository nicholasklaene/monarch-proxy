...
/**
 * Monarch `Web_UpdateForecastScenario` op wired as an opaque FreeForm pass-through. The
 ...
 */
object UpdateForecastScenario : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_UpdateForecastScenario"
