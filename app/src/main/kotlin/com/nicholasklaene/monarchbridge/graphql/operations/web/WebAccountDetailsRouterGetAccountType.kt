...
/**
 * Web bundle screen-aggregate `Web_AccountDetailsRouter_getAccountType` (query). Wired as opaque pass-through:
 ...
 */
object WebAccountDetailsRouterGetAccountType : MonarchOperation<WebAccountDetailsRouterGetAccountType.Input, Map<String, Any>> {
    override val operationName: String = "Web_AccountDetailsRouter_getAccountType"
