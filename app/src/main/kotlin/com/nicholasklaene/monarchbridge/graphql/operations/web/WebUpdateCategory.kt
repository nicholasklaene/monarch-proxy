...
/**
 * Web bundle screen-aggregate `Web_UpdateCategory` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateCategory : MonarchOperation<WebUpdateCategory.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateCategory"
