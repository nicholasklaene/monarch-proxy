...
/**
 * Web bundle screen-aggregate `Web_ImportStatementGetAccount` (query). Wired as opaque pass-through:
 ...
 */
object WebImportStatementGetAccount : MonarchOperation<WebImportStatementGetAccount.Input, Map<String, Any>> {
    override val operationName: String = "Web_ImportStatementGetAccount"
