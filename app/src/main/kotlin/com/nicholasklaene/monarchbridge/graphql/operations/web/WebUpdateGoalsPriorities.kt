...
/**
 * Web bundle screen-aggregate `Web_UpdateGoalsPriorities` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateGoalsPriorities : MonarchOperation<WebUpdateGoalsPriorities.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateGoalsPriorities"
