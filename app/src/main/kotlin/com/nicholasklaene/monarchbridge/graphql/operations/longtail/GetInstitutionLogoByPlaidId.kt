...
/**
 * Long-tail wrapper for the `GetInstitutionLogoByPlaidId` GraphQL operation.
 *
 ...
 */
object GetInstitutionLogoByPlaidId : LongTailOperation("GetInstitutionLogoByPlaidId")
