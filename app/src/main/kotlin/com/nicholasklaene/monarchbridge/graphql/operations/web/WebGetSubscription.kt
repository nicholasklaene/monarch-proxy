...
/**
 * Web bundle screen-aggregate `Web_GetSubscription` (query). Wired as opaque pass-through:
 ...
 */
object WebGetSubscription : MonarchOperation<WebGetSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetSubscription"
