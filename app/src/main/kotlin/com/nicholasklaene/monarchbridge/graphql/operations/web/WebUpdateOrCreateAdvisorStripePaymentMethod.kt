...
/**
 * Web bundle screen-aggregate `Web_UpdateOrCreateAdvisorStripePaymentMethod` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateOrCreateAdvisorStripePaymentMethod : MonarchOperation<WebUpdateOrCreateAdvisorStripePaymentMethod.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateOrCreateAdvisorStripePaymentMethod"
