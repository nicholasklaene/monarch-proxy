...
/**
 * Long-tail wrapper for the `Common_ForceRefreshOperationQuery` GraphQL operation.
 *
 ...
 */
object ForceRefreshOperationQuery : LongTailOperation("Common_ForceRefreshOperationQuery")
