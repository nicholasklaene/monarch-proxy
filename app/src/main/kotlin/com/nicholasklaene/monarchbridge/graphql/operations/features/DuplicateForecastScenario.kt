...
/**
 * Monarch `Web_DuplicateForecastScenario` op wired as an opaque FreeForm pass-through. The
 ...
 */
object DuplicateForecastScenario : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_DuplicateForecastScenario"
