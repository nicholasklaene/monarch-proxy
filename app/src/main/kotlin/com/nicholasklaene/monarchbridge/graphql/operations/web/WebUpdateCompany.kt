...
/**
 * Web bundle screen-aggregate `Web_UpdateCompany` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateCompany : MonarchOperation<WebUpdateCompany.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateCompany"
