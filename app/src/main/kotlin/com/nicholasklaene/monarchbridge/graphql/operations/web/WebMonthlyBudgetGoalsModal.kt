...
/**
 * Web bundle screen-aggregate `Web_MonthlyBudgetGoalsModal` (query). Wired as opaque pass-through:
 ...
 */
object WebMonthlyBudgetGoalsModal : MonarchOperation<WebMonthlyBudgetGoalsModal.Input, Map<String, Any>> {
    override val operationName: String = "Web_MonthlyBudgetGoalsModal"
