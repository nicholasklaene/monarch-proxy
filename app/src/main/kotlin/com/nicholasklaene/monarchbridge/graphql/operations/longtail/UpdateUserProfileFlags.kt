...
/**
 * Long-tail wrapper for the `Common_UpdateUserProfileFlags` GraphQL operation.
 *
 ...
 */
object UpdateUserProfileFlags : LongTailOperation("Common_UpdateUserProfileFlags")
