...
/**
 * Long-tail wrapper for the `Common_UnreconciledSpendingEvents` GraphQL operation.
 *
 ...
 */
object UnreconciledSpendingEvents : LongTailOperation("Common_UnreconciledSpendingEvents")
