...
/**
 * Monarch `Web_DeleteForecastScenario` op wired as an opaque FreeForm pass-through. The
 ...
 */
object DeleteForecastScenario : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_DeleteForecastScenario"
