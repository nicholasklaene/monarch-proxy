...
/**
 * Web bundle screen-aggregate `Web_GetPlanRecommendationData` (query). Wired as opaque pass-through:
 ...
 */
object WebGetPlanRecommendationData : MonarchOperation<WebGetPlanRecommendationData.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetPlanRecommendationData"
