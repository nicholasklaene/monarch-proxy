...
/**
 * Web bundle screen-aggregate `Web_SetEmployeeCancellationDiscountUsed` (mutation). Wired as opaque pass-through:
 ...
 */
object WebSetEmployeeCancellationDiscountUsed : MonarchOperation<WebSetEmployeeCancellationDiscountUsed.Input, Map<String, Any>> {
    override val operationName: String = "Web_SetEmployeeCancellationDiscountUsed"
