...
/**
 * Monarch `Web_PreviewEquityGrant` op wired as an opaque FreeForm pass-through. The
 ...
 */
object PreviewEquityGrant : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_PreviewEquityGrant"
