...
/**
 * Web bundle screen-aggregate `Web_UpdateSubscriptionSponsor` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateSubscriptionSponsor : MonarchOperation<WebUpdateSubscriptionSponsor.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateSubscriptionSponsor"
