...
/**
 * Web bundle screen-aggregate `Web_UpdateCategoryOrder` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateCategoryOrder : MonarchOperation<WebUpdateCategoryOrder.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateCategoryOrder"
