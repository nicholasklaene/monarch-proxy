...
/**
 * Web bundle screen-aggregate `Web_GetAdvisorProfilePage` (query). Wired as opaque pass-through:
 ...
 */
object WebGetAdvisorProfilePage : MonarchOperation<WebGetAdvisorProfilePage.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetAdvisorProfilePage"
