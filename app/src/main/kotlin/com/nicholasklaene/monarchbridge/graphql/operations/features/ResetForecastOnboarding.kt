...
/**
 * Monarch `Web_ResetForecastOnboarding` op wired as an opaque FreeForm pass-through. The
 ...
 */
object ResetForecastOnboarding : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_ResetForecastOnboarding"
