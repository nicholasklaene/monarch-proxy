...
/**
 * Web bundle screen-aggregate `Web_confirmTotpDevice` (mutation). Wired as opaque pass-through:
 ...
 */
object WebConfirmTotpDevice : MonarchOperation<WebConfirmTotpDevice.Input, Map<String, Any>> {
    override val operationName: String = "Web_confirmTotpDevice"
