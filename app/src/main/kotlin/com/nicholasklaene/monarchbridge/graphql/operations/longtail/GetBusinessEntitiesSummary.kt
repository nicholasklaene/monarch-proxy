...
/**
 * Long-tail wrapper for the `Common_GetBusinessEntitiesSummary` GraphQL operation.
 *
 ...
 */
object GetBusinessEntitiesSummary : LongTailOperation("Common_GetBusinessEntitiesSummary")
