...
/**
 * Web bundle screen-aggregate `Web_RecommendedAccounts` (query). Wired as opaque pass-through:
 ...
 */
object WebRecommendedAccounts : MonarchOperation<WebRecommendedAccounts.Input, Map<String, Any>> {
    override val operationName: String = "Web_RecommendedAccounts"
