...
/**
 * Web bundle screen-aggregate `Web_GetInvestmentsHoldingDrawerHistoricalPerformance` (query). Wired as opaque pass-through:
 ...
 */
object WebGetInvestmentsHoldingDrawerHistoricalPerformance :
    MonarchOperation<WebGetInvestmentsHoldingDrawerHistoricalPerformance.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetInvestmentsHoldingDrawerHistoricalPerformance"
