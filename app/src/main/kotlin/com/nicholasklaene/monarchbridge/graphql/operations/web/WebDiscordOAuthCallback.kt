...
/**
 * Web bundle screen-aggregate `Web_DiscordOAuthCallback` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDiscordOAuthCallback : MonarchOperation<WebDiscordOAuthCallback.Input, Map<String, Any>> {
    override val operationName: String = "Web_DiscordOAuthCallback"
