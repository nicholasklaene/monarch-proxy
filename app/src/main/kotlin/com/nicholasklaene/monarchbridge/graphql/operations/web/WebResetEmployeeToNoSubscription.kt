...
/**
 * Web bundle screen-aggregate `Web_ResetEmployeeToNoSubscription` (mutation). Wired as opaque pass-through:
 ...
 */
object WebResetEmployeeToNoSubscription : MonarchOperation<WebResetEmployeeToNoSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_ResetEmployeeToNoSubscription"
