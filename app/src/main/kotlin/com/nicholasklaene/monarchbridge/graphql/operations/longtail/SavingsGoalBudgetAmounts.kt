...
/**
 * Long-tail wrapper for the `Common_SavingsGoalBudgetAmounts` GraphQL operation.
 *
 ...
 */
object SavingsGoalBudgetAmounts : LongTailOperation("Common_SavingsGoalBudgetAmounts")
