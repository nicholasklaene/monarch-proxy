...
/**
 * Long-tail wrapper for the `Common_MatchRetailTransaction` GraphQL operation.
 *
 ...
 */
object MatchRetailTransaction : LongTailOperation("Common_MatchRetailTransaction")
