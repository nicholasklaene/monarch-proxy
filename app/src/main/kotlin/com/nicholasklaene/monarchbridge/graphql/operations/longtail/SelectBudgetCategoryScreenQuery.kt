...
/**
 * Long-tail wrapper for the `SelectBudgetCategoryScreenQuery` GraphQL operation.
 *
 ...
 */
object SelectBudgetCategoryScreenQuery : LongTailOperation("SelectBudgetCategoryScreenQuery")
