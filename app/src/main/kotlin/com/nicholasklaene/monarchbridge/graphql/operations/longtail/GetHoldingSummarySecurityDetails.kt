...
/**
 * Long-tail wrapper for the `GetHoldingSummarySecurityDetails` GraphQL operation.
 *
 ...
 */
object GetHoldingSummarySecurityDetails : LongTailOperation("GetHoldingSummarySecurityDetails")
