 ...
 */
object RapidTransactionReviewFormContainer : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Mobile_RapidTransactionReviewFormContainer"
