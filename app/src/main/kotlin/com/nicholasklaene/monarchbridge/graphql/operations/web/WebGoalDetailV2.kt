...
/**
 * Web bundle screen-aggregate `Web_GoalDetailV2` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalDetailV2 : MonarchOperation<WebGoalDetailV2.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalDetailV2"
