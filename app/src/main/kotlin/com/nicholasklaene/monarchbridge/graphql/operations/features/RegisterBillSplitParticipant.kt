...
/**
 * Monarch `Web_RegisterBillSplitParticipant` op wired as an opaque FreeForm pass-through. The
 ...
 */
object RegisterBillSplitParticipant : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_RegisterBillSplitParticipant"
