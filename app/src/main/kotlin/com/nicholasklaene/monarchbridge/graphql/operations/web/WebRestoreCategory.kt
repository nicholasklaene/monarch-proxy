...
/**
 * Web bundle screen-aggregate `Web_RestoreCategory` (mutation). Wired as opaque pass-through:
 ...
 */
object WebRestoreCategory : MonarchOperation<WebRestoreCategory.Input, Map<String, Any>> {
    override val operationName: String = "Web_RestoreCategory"
