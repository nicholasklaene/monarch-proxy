...
/**
 * Web bundle screen-aggregate `Web_ResetCategorizationMemory` (mutation). Wired as opaque pass-through:
 ...
 */
object WebResetCategorizationMemory : MonarchOperation<WebResetCategorizationMemory.Input, Map<String, Any>> {
    override val operationName: String = "Web_ResetCategorizationMemory"
