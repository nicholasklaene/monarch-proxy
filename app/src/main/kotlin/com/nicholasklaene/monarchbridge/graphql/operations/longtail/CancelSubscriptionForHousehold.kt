...
/**
 * Long-tail wrapper for the `Common_CancelSubscriptionForHousehold` GraphQL operation.
 *
 ...
 */
object CancelSubscriptionForHousehold : LongTailOperation("Common_CancelSubscriptionForHousehold")
