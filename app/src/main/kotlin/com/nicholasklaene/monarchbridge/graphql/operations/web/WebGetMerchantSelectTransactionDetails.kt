...
/**
 * Web bundle screen-aggregate `Web_GetMerchantSelectTransactionDetails` (query). Wired as opaque pass-through:
 ...
 */
object WebGetMerchantSelectTransactionDetails : MonarchOperation<WebGetMerchantSelectTransactionDetails.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetMerchantSelectTransactionDetails"
