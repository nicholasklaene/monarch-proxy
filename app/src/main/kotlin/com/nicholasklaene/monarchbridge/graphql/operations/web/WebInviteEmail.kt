...
/**
 * Web bundle screen-aggregate `Web_InviteEmail` (mutation). Wired as opaque pass-through:
 ...
 */
object WebInviteEmail : MonarchOperation<WebInviteEmail.Input, Map<String, Any>> {
    override val operationName: String = "Web_InviteEmail"
