...
/**
 * Monarch `Web_UpdateForecastScenarioOrder` op wired as an opaque FreeForm pass-through. The
 ...
 */
object UpdateForecastScenarioOrder : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_UpdateForecastScenarioOrder"
