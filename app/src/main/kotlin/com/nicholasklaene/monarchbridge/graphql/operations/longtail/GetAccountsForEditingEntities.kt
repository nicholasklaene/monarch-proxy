...
/**
 * Long-tail wrapper for the `Common_GetAccountsForEditingEntities` GraphQL operation.
 *
 ...
 */
object GetAccountsForEditingEntities : LongTailOperation("Common_GetAccountsForEditingEntities")
