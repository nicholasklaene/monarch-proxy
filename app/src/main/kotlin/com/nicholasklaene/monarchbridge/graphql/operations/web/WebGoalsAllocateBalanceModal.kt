...
/**
 * Web bundle screen-aggregate `Web_GoalsAllocateBalanceModal` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalsAllocateBalanceModal : MonarchOperation<WebGoalsAllocateBalanceModal.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalsAllocateBalanceModal"
