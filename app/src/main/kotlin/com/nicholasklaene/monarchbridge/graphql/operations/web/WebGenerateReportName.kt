...
/**
 * Web bundle screen-aggregate `Web_GenerateReportName` (query). Wired as opaque pass-through:
 ...
 */
object WebGenerateReportName : MonarchOperation<WebGenerateReportName.Input, Map<String, Any>> {
    override val operationName: String = "Web_GenerateReportName"
