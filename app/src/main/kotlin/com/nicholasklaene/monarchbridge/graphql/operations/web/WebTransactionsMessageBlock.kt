...
/**
 * Web bundle screen-aggregate `Web_TransactionsMessageBlock` (query). Wired as opaque pass-through:
 ...
 */
object WebTransactionsMessageBlock : MonarchOperation<WebTransactionsMessageBlock.Input, Map<String, Any>> {
    override val operationName: String = "Web_TransactionsMessageBlock"
