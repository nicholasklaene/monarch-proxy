...
/**
 * Web bundle screen-aggregate `Web_PreTaxBudgetGoalsList` (query). Wired as opaque pass-through:
 ...
 */
object WebPreTaxBudgetGoalsList : MonarchOperation<WebPreTaxBudgetGoalsList.Input, Map<String, Any>> {
    override val operationName: String = "Web_PreTaxBudgetGoalsList"
