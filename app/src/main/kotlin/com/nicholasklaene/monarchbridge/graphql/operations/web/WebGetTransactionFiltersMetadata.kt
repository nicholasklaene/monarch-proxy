...
/**
 * Web bundle screen-aggregate `Web_GetTransactionFiltersMetadata` (query). Wired as opaque pass-through:
 ...
 */
object WebGetTransactionFiltersMetadata : MonarchOperation<WebGetTransactionFiltersMetadata.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetTransactionFiltersMetadata"
