...
/**
 * Web bundle screen-aggregate `Web_GoalsMapAccountsModal` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalsMapAccountsModal : MonarchOperation<WebGoalsMapAccountsModal.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalsMapAccountsModal"
