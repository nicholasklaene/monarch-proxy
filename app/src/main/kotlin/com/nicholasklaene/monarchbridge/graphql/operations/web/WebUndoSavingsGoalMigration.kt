...
/**
 * Web bundle screen-aggregate `Web_UndoSavingsGoalMigration` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUndoSavingsGoalMigration : MonarchOperation<WebUndoSavingsGoalMigration.Input, Map<String, Any>> {
    override val operationName: String = "Web_UndoSavingsGoalMigration"
