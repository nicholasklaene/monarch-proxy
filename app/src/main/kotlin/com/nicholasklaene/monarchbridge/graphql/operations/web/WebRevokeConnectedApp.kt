...
/**
 * Web bundle screen-aggregate `Web_RevokeConnectedApp` (mutation). Wired as opaque pass-through:
 ...
 */
object WebRevokeConnectedApp : MonarchOperation<WebRevokeConnectedApp.Input, Map<String, Any>> {
    override val operationName: String = "Web_RevokeConnectedApp"
