...
/**
 * Web bundle screen-aggregate `Web_GetAccount` (query). Wired as opaque pass-through:
 ...
 */
object WebGetAccount : MonarchOperation<WebGetAccount.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetAccount"
