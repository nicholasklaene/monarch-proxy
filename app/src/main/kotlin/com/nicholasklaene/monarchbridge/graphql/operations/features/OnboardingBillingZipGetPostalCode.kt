...
/**
 * Monarch `Web_OnboardingBillingZip_GetPostalCode` op wired as an opaque FreeForm pass-through. The
 ...
 */
object OnboardingBillingZipGetPostalCode : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_OnboardingBillingZip_GetPostalCode"
