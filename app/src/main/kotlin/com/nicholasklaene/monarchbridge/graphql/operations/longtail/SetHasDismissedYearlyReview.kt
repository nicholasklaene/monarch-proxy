...
/**
 * Long-tail wrapper for the `Common_SetHasDismissedYearlyReview` GraphQL operation.
 *
 ...
 */
object SetHasDismissedYearlyReview : LongTailOperation("Common_SetHasDismissedYearlyReview")
