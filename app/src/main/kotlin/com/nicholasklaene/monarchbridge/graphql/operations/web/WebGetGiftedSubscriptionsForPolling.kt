...
/**
 * Web bundle screen-aggregate `Web_GetGiftedSubscriptionsForPolling` (query). Wired as opaque pass-through:
 ...
 */
object WebGetGiftedSubscriptionsForPolling : MonarchOperation<WebGetGiftedSubscriptionsForPolling.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetGiftedSubscriptionsForPolling"
