...
/**
 * Web bundle screen-aggregate `Web_ClearAllMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebClearAllMutation : MonarchOperation<WebClearAllMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_ClearAllMutation"
