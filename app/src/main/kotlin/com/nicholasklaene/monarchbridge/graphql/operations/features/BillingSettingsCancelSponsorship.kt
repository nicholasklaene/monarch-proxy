...
/**
 * Monarch `Web_BillingSettingsCancelSponsorship` op wired as an opaque FreeForm pass-through. The
 ...
 */
object BillingSettingsCancelSponsorship : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_BillingSettingsCancelSponsorship"
