...
/**
 * Long-tail wrapper for the `Common_SetUserReportedAttributionChannels` GraphQL operation.
 *
 ...
 */
object SetUserReportedAttributionChannels : LongTailOperation("Common_SetUserReportedAttributionChannels")
