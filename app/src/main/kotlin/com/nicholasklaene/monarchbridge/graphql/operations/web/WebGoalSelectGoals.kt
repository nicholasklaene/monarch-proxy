...
/**
 * Web bundle screen-aggregate `Web_GoalSelectGoals` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalSelectGoals : MonarchOperation<WebGoalSelectGoals.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalSelectGoals"
