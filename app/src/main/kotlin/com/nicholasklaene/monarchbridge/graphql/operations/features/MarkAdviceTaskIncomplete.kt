...
/**
 * Monarch `Web_MarkAdviceTaskIncomplete` op wired as an opaque FreeForm pass-through. The
 * deep response tree is intentionally untyped (Map<String, Any>) because the
 * `Advice` feature surface churns across Monarch releases; modeling each leaf
 ...
 */
object MarkAdviceTaskIncomplete : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_MarkAdviceTaskIncomplete"
