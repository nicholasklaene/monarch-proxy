...
/**
 * Web bundle screen-aggregate `Web_GetSecuritySettings` (query). Wired as opaque pass-through:
 ...
 */
object WebGetSecuritySettings : MonarchOperation<WebGetSecuritySettings.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetSecuritySettings"
