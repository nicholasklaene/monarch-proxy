...
/**
 * Long-tail wrapper for the `Common_RecurringUpdateMerchant` GraphQL operation.
 *
 ...
 */
object RecurringUpdateMerchant : LongTailOperation("Common_RecurringUpdateMerchant")
