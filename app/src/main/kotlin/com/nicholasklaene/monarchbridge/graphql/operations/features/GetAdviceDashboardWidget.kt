...
/**
 * Monarch `Web_GetAdviceDashboardWidget` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetAdviceDashboardWidget : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_GetAdviceDashboardWidget"
