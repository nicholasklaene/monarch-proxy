...
/**
 * Web bundle screen-aggregate `Web_GoalSelectTransaction` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalSelectTransaction : MonarchOperation<WebGoalSelectTransaction.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalSelectTransaction"
