...
/**
 * Monarch `Web_GetEmployeeBillingState` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetEmployeeBillingState : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_GetEmployeeBillingState"
