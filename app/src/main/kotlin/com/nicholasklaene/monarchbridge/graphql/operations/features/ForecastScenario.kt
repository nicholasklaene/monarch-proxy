...
/**
 * Monarch `Web_ForecastScenario` op wired as an opaque FreeForm pass-through. The
 ...
 */
object ForecastScenario : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_ForecastScenario"
