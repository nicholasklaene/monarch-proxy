...
/**
 * Long-tail wrapper for the `Common_SavingsGoalAccountsAllocationSummary` GraphQL operation.
 *
 ...
 */
object SavingsGoalAccountsAllocationSummary : LongTailOperation("Common_SavingsGoalAccountsAllocationSummary")
