...
/**
 * Monarch `Web_BillingZipModal_UpdateBillingPostalCode` op wired as an opaque FreeForm pass-through. The
 ...
 */
object BillingZipModalUpdatePostalCode : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_BillingZipModal_UpdateBillingPostalCode"
