...
/**
 * Web bundle screen-aggregate `Web_TransactionsFilterQuery` (query). Wired as opaque pass-through:
 ...
 */
object WebTransactionsFilterQuery : MonarchOperation<WebTransactionsFilterQuery.Input, Map<String, Any>> {
    override val operationName: String = "Web_TransactionsFilterQuery"
