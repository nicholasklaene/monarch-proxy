...
/**
 * Long-tail wrapper for the `Common_GetDecagonSubscriptionStatus` GraphQL operation.
 *
 ...
 */
object GetDecagonSubscriptionStatus : LongTailOperation("Common_GetDecagonSubscriptionStatus")
