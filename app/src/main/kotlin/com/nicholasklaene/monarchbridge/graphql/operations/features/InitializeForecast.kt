...
/**
 * Monarch `Web_InitializeForecast` op wired as an opaque FreeForm pass-through. The
 ...
 */
object InitializeForecast : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_InitializeForecast"
