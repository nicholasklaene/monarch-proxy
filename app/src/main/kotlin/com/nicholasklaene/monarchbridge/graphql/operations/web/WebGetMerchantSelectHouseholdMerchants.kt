...
/**
 * Web bundle screen-aggregate `Web_GetMerchantSelectHouseholdMerchants` (query). Wired as opaque pass-through:
 ...
 */
object WebGetMerchantSelectHouseholdMerchants : MonarchOperation<WebGetMerchantSelectHouseholdMerchants.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetMerchantSelectHouseholdMerchants"
