...
/**
 * Web bundle screen-aggregate `Web_createUnconfirmedTotpDevice` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateUnconfirmedTotpDevice : MonarchOperation<WebCreateUnconfirmedTotpDevice.Input, Map<String, Any>> {
    override val operationName: String = "Web_createUnconfirmedTotpDevice"
