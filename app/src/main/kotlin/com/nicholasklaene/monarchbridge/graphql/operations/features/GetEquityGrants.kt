...
/**
 * Monarch `Web_GetEquityGrants` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetEquityGrants : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_GetEquityGrants"
