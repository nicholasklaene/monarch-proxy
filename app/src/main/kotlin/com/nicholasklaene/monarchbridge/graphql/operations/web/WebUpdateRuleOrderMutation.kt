...
/**
 * Web bundle screen-aggregate `Web_UpdateRuleOrderMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateRuleOrderMutation : MonarchOperation<WebUpdateRuleOrderMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateRuleOrderMutation"
