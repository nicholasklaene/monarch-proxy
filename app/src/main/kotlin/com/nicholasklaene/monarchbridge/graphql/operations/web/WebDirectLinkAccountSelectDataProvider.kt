...
/**
 * Web bundle screen-aggregate `Web_DirectLinkAccountSelectDataProvider` (query). Wired as opaque pass-through:
 ...
 */
object WebDirectLinkAccountSelectDataProvider : MonarchOperation<WebDirectLinkAccountSelectDataProvider.Input, Map<String, Any>> {
    override val operationName: String = "Web_DirectLinkAccountSelectDataProvider"
