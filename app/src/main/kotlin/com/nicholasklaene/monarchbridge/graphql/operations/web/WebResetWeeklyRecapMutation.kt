...
/**
 * Web bundle screen-aggregate `Web_ResetWeeklyRecapMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebResetWeeklyRecapMutation : MonarchOperation<WebResetWeeklyRecapMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_ResetWeeklyRecapMutation"
