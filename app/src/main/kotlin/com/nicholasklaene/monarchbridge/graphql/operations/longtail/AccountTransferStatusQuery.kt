...
/**
 * Long-tail wrapper for the `Common_AccountTransferStatusQuery` GraphQL operation.
 *
 ...
 */
object AccountTransferStatusQuery : LongTailOperation("Common_AccountTransferStatusQuery")
