...
/**
 * Long-tail wrapper for the `Common_UpdateDoNotSellOrShare` GraphQL operation.
 *
 ...
 */
object UpdateDoNotSellOrShare : LongTailOperation("Common_UpdateDoNotSellOrShare")
