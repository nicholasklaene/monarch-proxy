...
/**
 * Web bundle screen-aggregate `Web_CreateCoinbaseAccount` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateCoinbaseAccount : MonarchOperation<WebCreateCoinbaseAccount.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreateCoinbaseAccount"
