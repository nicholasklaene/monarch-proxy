...
/**
 * Web bundle screen-aggregate `Web_PreviewAccountDataTransferSnapshots` (query). Wired as opaque pass-through:
 ...
 */
object WebPreviewAccountDataTransferSnapshots : MonarchOperation<WebPreviewAccountDataTransferSnapshots.Input, Map<String, Any>> {
    override val operationName: String = "Web_PreviewAccountDataTransferSnapshots"
