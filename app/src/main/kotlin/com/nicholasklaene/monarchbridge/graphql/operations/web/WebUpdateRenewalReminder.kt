...
/**
 * Web bundle screen-aggregate `Web_UpdateRenewalReminder` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateRenewalReminder : MonarchOperation<WebUpdateRenewalReminder.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateRenewalReminder"
