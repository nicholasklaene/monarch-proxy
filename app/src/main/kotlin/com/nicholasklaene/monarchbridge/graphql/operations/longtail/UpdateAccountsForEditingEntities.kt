...
/**
 * Long-tail wrapper for the `Common_UpdateAccountsForEditingEntities` GraphQL operation.
 *
 ...
 */
object UpdateAccountsForEditingEntities : LongTailOperation("Common_UpdateAccountsForEditingEntities")
