...
/**
 * Web bundle screen-aggregate `Web_GiveEmployeeInfinitePlusAccess` (mutation). Wired as opaque pass-through:
 ...
 */
object WebGiveEmployeeInfinitePlusAccess : MonarchOperation<WebGiveEmployeeInfinitePlusAccess.Input, Map<String, Any>> {
    override val operationName: String = "Web_GiveEmployeeInfinitePlusAccess"
