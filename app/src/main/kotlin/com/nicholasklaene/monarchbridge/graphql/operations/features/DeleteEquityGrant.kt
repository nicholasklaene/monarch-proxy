...
/**
 * Monarch `Web_DeleteEquityGrant` op wired as an opaque FreeForm pass-through. The
 ...
 */
object DeleteEquityGrant : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_DeleteEquityGrant"
