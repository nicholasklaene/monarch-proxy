...
/**
 * Web bundle screen-aggregate `Web_DeleteAllTransactionRulesMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDeleteAllTransactionRulesMutation : MonarchOperation<WebDeleteAllTransactionRulesMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_DeleteAllTransactionRulesMutation"
