...
/**
 * Monarch `Web_AdviceQuestionnaire` op wired as an opaque FreeForm pass-through. The
 ...
 */
object AdviceQuestionnaire : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_AdviceQuestionnaire"
