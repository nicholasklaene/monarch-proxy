...
/**
 * Monarch `Web_SubmitBillSplitInitiatorEdit` op wired as an opaque FreeForm pass-through. The
 ...
 */
object SubmitBillSplitInitiatorEdit : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_SubmitBillSplitInitiatorEdit"
