...
/**
 * Web bundle screen-aggregate `Web_GetTopInstitutionGroupByType` (query). Wired as opaque pass-through:
 ...
 */
object WebGetTopInstitutionGroupByType : MonarchOperation<WebGetTopInstitutionGroupByType.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetTopInstitutionGroupByType"
