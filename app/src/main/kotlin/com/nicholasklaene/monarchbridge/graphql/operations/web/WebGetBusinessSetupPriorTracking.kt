...
/**
 * Web bundle screen-aggregate `Web_GetBusinessSetupPriorTracking` (query). Wired as opaque pass-through:
 ...
 */
object WebGetBusinessSetupPriorTracking : MonarchOperation<WebGetBusinessSetupPriorTracking.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetBusinessSetupPriorTracking"
