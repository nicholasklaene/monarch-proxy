...
/**
 * Web bundle screen-aggregate `Web_ParseUploadStatementSession` (mutation). Wired as opaque pass-through:
 ...
 */
object WebParseUploadStatementSession : MonarchOperation<WebParseUploadStatementSession.Input, Map<String, Any>> {
    override val operationName: String = "Web_ParseUploadStatementSession"
