...
/**
 * Long-tail wrapper for the `Common_GetHouseHoldMemberSettings` GraphQL operation.
 *
 ...
 */
object GetHouseHoldMemberSettings : LongTailOperation("Common_GetHouseHoldMemberSettings")
