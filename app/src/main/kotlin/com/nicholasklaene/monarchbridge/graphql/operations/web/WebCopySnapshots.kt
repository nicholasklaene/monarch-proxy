...
/**
 * Web bundle screen-aggregate `Web_CopySnapshots` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCopySnapshots : MonarchOperation<WebCopySnapshots.Input, Map<String, Any>> {
    override val operationName: String = "Web_CopySnapshots"
