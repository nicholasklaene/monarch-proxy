...
/**
 * Web bundle screen-aggregate `Web_GetInvestmentsAccounts` (query). Wired as opaque pass-through:
 ...
 */
object WebGetInvestmentsAccounts : MonarchOperation<WebGetInvestmentsAccounts.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetInvestmentsAccounts"
