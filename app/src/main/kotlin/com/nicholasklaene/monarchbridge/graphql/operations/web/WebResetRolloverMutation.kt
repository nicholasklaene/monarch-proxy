...
/**
 * Web bundle screen-aggregate `Web_ResetRolloverMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebResetRolloverMutation : MonarchOperation<WebResetRolloverMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_ResetRolloverMutation"
