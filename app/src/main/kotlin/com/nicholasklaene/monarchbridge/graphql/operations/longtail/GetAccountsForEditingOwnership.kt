...
/**
 * Long-tail wrapper for the `Common_GetAccountsForEditingOwnership` GraphQL operation.
 *
 ...
 */
object GetAccountsForEditingOwnership : LongTailOperation("Common_GetAccountsForEditingOwnership")
