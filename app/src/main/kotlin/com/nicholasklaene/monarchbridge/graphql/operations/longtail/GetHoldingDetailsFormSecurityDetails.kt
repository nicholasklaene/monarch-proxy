...
/**
 * Long-tail wrapper for the `GetHoldingDetailsFormSecurityDetails` GraphQL operation.
 *
 ...
 */
object GetHoldingDetailsFormSecurityDetails : LongTailOperation("GetHoldingDetailsFormSecurityDetails")
