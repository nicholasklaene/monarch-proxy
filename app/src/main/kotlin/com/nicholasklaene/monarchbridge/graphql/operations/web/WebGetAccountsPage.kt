...
/**
 * Web bundle screen-aggregate `Web_GetAccountsPage` (query). Wired as opaque pass-through:
 ...
 */
object WebGetAccountsPage : MonarchOperation<WebGetAccountsPage.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetAccountsPage"
