...
/**
 * Monarch `Common_GetBusinessEntity` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetBusinessEntity : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_GetBusinessEntity"
