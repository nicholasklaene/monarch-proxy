...
/**
 * Web bundle screen-aggregate `Web_GetMeCollaborationProfileStep` (query). Wired as opaque pass-through:
 ...
 */
object WebGetMeCollaborationProfileStep : MonarchOperation<WebGetMeCollaborationProfileStep.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetMeCollaborationProfileStep"
