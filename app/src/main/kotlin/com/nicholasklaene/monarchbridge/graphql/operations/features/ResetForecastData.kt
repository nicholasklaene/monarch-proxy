...
/**
 * Monarch `Web_ResetForecastData` op wired as an opaque FreeForm pass-through. The
 ...
 */
object ResetForecastData : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_ResetForecastData"
