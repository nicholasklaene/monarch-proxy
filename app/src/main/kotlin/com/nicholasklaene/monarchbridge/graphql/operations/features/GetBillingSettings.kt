...
/**
 * Monarch `GetBillingSettings` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetBillingSettings : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "GetBillingSettings"
