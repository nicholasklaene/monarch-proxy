...
/**
 * Monarch `Common_DeleteBusinessEntity` op wired as an opaque FreeForm pass-through. The
 ...
 */
object DeleteBusinessEntity : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_DeleteBusinessEntity"
