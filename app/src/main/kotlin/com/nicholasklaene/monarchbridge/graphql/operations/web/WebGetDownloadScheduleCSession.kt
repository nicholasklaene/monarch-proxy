...
/**
 * Web bundle screen-aggregate `Web_GetDownloadScheduleCSession` (query). Wired as opaque pass-through:
 ...
 */
object WebGetDownloadScheduleCSession : MonarchOperation<WebGetDownloadScheduleCSession.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetDownloadScheduleCSession"
