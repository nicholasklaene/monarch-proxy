...
/**
 * Monarch `Web_GetBill` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetBill : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_GetBill"
