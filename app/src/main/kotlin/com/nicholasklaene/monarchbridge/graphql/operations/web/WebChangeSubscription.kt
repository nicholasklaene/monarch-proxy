...
/**
 * Web bundle screen-aggregate `Web_ChangeSubscription` (mutation). Wired as opaque pass-through:
 ...
 */
object WebChangeSubscription : MonarchOperation<WebChangeSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_ChangeSubscription"
