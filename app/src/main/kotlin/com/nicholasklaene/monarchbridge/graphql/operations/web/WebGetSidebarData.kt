...
/**
 * Web bundle screen-aggregate `Web_GetSidebarData` (query). Wired as opaque pass-through:
 ...
 */
object WebGetSidebarData : MonarchOperation<WebGetSidebarData.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetSidebarData"
