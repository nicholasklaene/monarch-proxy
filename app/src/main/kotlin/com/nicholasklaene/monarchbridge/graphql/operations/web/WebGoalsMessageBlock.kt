...
/**
 * Web bundle screen-aggregate `Web_GoalsMessageBlock` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalsMessageBlock : MonarchOperation<WebGoalsMessageBlock.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalsMessageBlock"
