...
/**
 * Long-tail wrapper for the `Common_SetDebtPaydownBudgetAmount` GraphQL operation.
 *
 ...
 */
object SetDebtPaydownBudgetAmount : LongTailOperation("Common_SetDebtPaydownBudgetAmount")
