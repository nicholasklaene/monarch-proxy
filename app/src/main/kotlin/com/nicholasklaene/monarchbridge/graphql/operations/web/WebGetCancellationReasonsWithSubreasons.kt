...
/**
 * Web bundle screen-aggregate `Web_GetCancellationReasonsWithSubreasons` (query). Wired as opaque pass-through:
 ...
 */
object WebGetCancellationReasonsWithSubreasons : MonarchOperation<WebGetCancellationReasonsWithSubreasons.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetCancellationReasonsWithSubreasons"
