...
/**
 * Monarch `Web_SaveForecastParticipantOverrides` op wired as an opaque FreeForm pass-through. The
 ...
 */
object SaveForecastParticipantOverrides : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_SaveForecastParticipantOverrides"
