 ...
 */
object GetSelectMerchantScreenRecommendedMerchants : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Mobile_GetSelectMerchantScreenRecommendedMerchants"
