...
/**
 * Long-tail wrapper for the `Common_RecordSmartPromptImpressions` GraphQL operation.
 *
 ...
 */
object RecordSmartPromptImpressions : LongTailOperation("Common_RecordSmartPromptImpressions")
