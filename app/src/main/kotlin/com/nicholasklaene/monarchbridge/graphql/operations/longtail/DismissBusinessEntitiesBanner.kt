...
/**
 * Long-tail wrapper for the `Common_DismissBusinessEntitiesBanner` GraphQL operation.
 *
 ...
 */
object DismissBusinessEntitiesBanner : LongTailOperation("Common_DismissBusinessEntitiesBanner")
