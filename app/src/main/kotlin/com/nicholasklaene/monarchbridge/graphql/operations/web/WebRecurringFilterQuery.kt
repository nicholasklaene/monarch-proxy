...
/**
 * Web bundle screen-aggregate `Web_RecurringFilterQuery` (query). Wired as opaque pass-through:
 ...
 */
object WebRecurringFilterQuery : MonarchOperation<WebRecurringFilterQuery.Input, Map<String, Any>> {
    override val operationName: String = "Web_RecurringFilterQuery"
