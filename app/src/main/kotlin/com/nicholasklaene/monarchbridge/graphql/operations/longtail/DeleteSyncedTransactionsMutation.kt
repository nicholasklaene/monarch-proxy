...
/**
 * Long-tail wrapper for the `Common_DeleteSyncedTransactionsMutation` GraphQL operation.
 *
 ...
 */
object DeleteSyncedTransactionsMutation : LongTailOperation("Common_DeleteSyncedTransactionsMutation")
