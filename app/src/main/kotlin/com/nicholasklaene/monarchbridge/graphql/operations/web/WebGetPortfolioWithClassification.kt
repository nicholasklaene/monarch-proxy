...
/**
 * Web bundle screen-aggregate `Web_GetPortfolioWithClassification` (query). Wired as opaque pass-through:
 ...
 */
object WebGetPortfolioWithClassification : MonarchOperation<WebGetPortfolioWithClassification.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetPortfolioWithClassification"
