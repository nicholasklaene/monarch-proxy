...
/**
 * Web bundle screen-aggregate `Web_CreatePromoCodeCheckoutSession` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreatePromoCodeCheckoutSession : MonarchOperation<WebCreatePromoCodeCheckoutSession.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreatePromoCodeCheckoutSession"
