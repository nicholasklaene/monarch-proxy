...
/**
 * Web bundle screen-aggregate `Web_UnmatchRetailTransaction` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUnmatchRetailTransaction : MonarchOperation<WebUnmatchRetailTransaction.Input, Map<String, Any>> {
    override val operationName: String = "Web_UnmatchRetailTransaction"
