...
/**
 * Monarch `Web_SaveForecastScenarioKpis` op wired as an opaque FreeForm pass-through. The
 ...
 */
object SaveForecastScenarioKpis : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_SaveForecastScenarioKpis"
