...
/**
 * Web bundle screen-aggregate `Web_ToggleSupportAccountAccess` (mutation). Wired as opaque pass-through:
 ...
 */
object WebToggleSupportAccountAccess : MonarchOperation<WebToggleSupportAccountAccess.Input, Map<String, Any>> {
    override val operationName: String = "Web_ToggleSupportAccountAccess"
