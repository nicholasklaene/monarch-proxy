...
/**
 * Monarch `Web_BillingSettings_HouseholdCountry` op wired as an opaque FreeForm pass-through. The
 ...
 */
object BillingSettingsHouseholdCountry : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_BillingSettings_HouseholdCountry"
