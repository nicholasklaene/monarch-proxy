...
/**
 * Web bundle screen-aggregate `Web_UpdateBusinessTrackingSetupIntent` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateBusinessTrackingSetupIntent : MonarchOperation<WebUpdateBusinessTrackingSetupIntent.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateBusinessTrackingSetupIntent"
