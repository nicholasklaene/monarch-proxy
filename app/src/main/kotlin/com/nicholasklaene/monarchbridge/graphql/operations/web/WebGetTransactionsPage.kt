...
/**
 * Web bundle screen-aggregate `Web_GetTransactionsPage` (query). Wired as opaque pass-through:
 ...
 */
object WebGetTransactionsPage : MonarchOperation<WebGetTransactionsPage.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetTransactionsPage"
