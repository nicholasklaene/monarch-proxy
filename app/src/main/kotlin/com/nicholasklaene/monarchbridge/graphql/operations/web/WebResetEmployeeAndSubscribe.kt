...
/**
 * Web bundle screen-aggregate `Web_ResetEmployeeAndSubscribe` (mutation). Wired as opaque pass-through:
 ...
 */
object WebResetEmployeeAndSubscribe : MonarchOperation<WebResetEmployeeAndSubscribe.Input, Map<String, Any>> {
    override val operationName: String = "Web_ResetEmployeeAndSubscribe"
