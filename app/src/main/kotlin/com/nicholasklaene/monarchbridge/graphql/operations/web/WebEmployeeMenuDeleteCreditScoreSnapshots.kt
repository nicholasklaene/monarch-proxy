...
/**
 * Web bundle screen-aggregate `Web_EmployeeMenuDeleteCreditScoreSnapshots` (mutation). Wired as opaque pass-through:
 ...
 */
object WebEmployeeMenuDeleteCreditScoreSnapshots : MonarchOperation<WebEmployeeMenuDeleteCreditScoreSnapshots.Input, Map<String, Any>> {
    override val operationName: String = "Web_EmployeeMenuDeleteCreditScoreSnapshots"
