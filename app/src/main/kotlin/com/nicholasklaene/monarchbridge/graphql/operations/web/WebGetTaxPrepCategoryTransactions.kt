...
/**
 * Web bundle screen-aggregate `Web_GetTaxPrepCategoryTransactions` (query). Wired as opaque pass-through:
 ...
 */
object WebGetTaxPrepCategoryTransactions : MonarchOperation<WebGetTaxPrepCategoryTransactions.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetTaxPrepCategoryTransactions"
