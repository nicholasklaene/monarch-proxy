...
/**
 * Monarch `Web_CreateEquityGrant` op wired as an opaque FreeForm pass-through. The
 ...
 */
object CreateEquityGrant : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_CreateEquityGrant"
