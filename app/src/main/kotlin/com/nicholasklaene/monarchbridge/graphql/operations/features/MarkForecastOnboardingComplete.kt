...
/**
 * Monarch `Web_MarkForecastOnboardingComplete` op wired as an opaque FreeForm pass-through. The
 ...
 */
object MarkForecastOnboardingComplete : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_MarkForecastOnboardingComplete"
