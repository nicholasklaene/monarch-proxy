...
/**
 * Web bundle screen-aggregate `Web_GetUserPlatforms` (query). Wired as opaque pass-through:
 ...
 */
object WebGetUserPlatforms : MonarchOperation<WebGetUserPlatforms.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetUserPlatforms"
