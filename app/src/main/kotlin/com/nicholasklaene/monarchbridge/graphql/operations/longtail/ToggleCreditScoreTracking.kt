...
/**
 * Long-tail wrapper for the `Common_ToggleCreditScoreTracking` GraphQL operation.
 *
 ...
 */
object ToggleCreditScoreTracking : LongTailOperation("Common_ToggleCreditScoreTracking")
