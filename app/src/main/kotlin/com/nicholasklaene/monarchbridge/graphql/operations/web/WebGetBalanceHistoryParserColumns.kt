...
/**
 * Web bundle screen-aggregate `Web_GetBalanceHistoryParserColumns` (query). Wired as opaque pass-through:
 ...
 */
object WebGetBalanceHistoryParserColumns : MonarchOperation<WebGetBalanceHistoryParserColumns.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetBalanceHistoryParserColumns"
