...
/**
 * Web bundle screen-aggregate `Web_EmployeeMenuGetFinancialInsightIds` (query). Wired as opaque pass-through:
 ...
 */
object WebEmployeeMenuGetFinancialInsightIds : MonarchOperation<WebEmployeeMenuGetFinancialInsightIds.Input, Map<String, Any>> {
    override val operationName: String = "Web_EmployeeMenuGetFinancialInsightIds"
