...
/**
 * Web bundle screen-aggregate `Web_ExtendFreeTrialDuration` (mutation). Wired as opaque pass-through:
 ...
 */
object WebExtendFreeTrialDuration : MonarchOperation<WebExtendFreeTrialDuration.Input, Map<String, Any>> {
    override val operationName: String = "Web_ExtendFreeTrialDuration"
