...
/**
 * Monarch `Web_EditEquityGrantModal_GetEquityGrant` op wired as an opaque FreeForm pass-through. The
 ...
 */
object EditEquityGrantModalGetEquityGrant : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_EditEquityGrantModal_GetEquityGrant"
