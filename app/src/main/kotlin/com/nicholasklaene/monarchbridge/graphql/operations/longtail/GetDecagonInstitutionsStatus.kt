...
/**
 * Long-tail wrapper for the `Common_GetDecagonInstitutionsStatus` GraphQL operation.
 *
 ...
 */
object GetDecagonInstitutionsStatus : LongTailOperation("Common_GetDecagonInstitutionsStatus")
