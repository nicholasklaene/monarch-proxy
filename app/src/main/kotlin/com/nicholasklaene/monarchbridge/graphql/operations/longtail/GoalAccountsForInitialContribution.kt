...
/**
 * Long-tail wrapper for the `Common_GoalAccountsForInitialContribution` GraphQL operation.
 *
 ...
 */
object GoalAccountsForInitialContribution : LongTailOperation("Common_GoalAccountsForInitialContribution")
