...
/**
 * Web bundle screen-aggregate `Web_InitScheduleCDefaultMappings` (mutation). Wired as opaque pass-through:
 ...
 */
object WebInitScheduleCDefaultMappings : MonarchOperation<WebInitScheduleCDefaultMappings.Input, Map<String, Any>> {
    override val operationName: String = "Web_InitScheduleCDefaultMappings"
