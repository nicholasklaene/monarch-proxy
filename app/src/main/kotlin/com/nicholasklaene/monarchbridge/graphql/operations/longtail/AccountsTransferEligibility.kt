...
/**
 * Long-tail wrapper for the `Common_AccountsTransferEligibility` GraphQL operation.
 *
 ...
 */
object AccountsTransferEligibility : LongTailOperation("Common_AccountsTransferEligibility")
