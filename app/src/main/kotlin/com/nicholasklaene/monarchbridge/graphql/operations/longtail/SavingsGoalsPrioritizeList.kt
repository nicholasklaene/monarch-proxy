...
/**
 * Long-tail wrapper for the `Common_SavingsGoalsPrioritizeList` GraphQL operation.
 *
 ...
 */
object SavingsGoalsPrioritizeList : LongTailOperation("Common_SavingsGoalsPrioritizeList")
