...
/**
 * Web bundle screen-aggregate `Web_RevokeSponsorshipInvite` (mutation). Wired as opaque pass-through:
 ...
 */
object WebRevokeSponsorshipInvite : MonarchOperation<WebRevokeSponsorshipInvite.Input, Map<String, Any>> {
    override val operationName: String = "Web_RevokeSponsorshipInvite"
