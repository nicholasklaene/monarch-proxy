...
/**
 * Web bundle screen-aggregate `Web_GetRecommendedCategories` (query). Wired as opaque pass-through:
 ...
 */
object WebGetRecommendedCategories : MonarchOperation<WebGetRecommendedCategories.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetRecommendedCategories"
