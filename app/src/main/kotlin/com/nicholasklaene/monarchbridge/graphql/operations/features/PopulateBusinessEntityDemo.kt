...
/**
 * Monarch `Web_PopulateBusinessEntityDemo` op wired as an opaque FreeForm pass-through. The
 ...
 */
object PopulateBusinessEntityDemo : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_PopulateBusinessEntityDemo"
