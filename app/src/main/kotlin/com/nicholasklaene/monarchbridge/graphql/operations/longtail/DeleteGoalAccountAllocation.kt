...
/**
 * Long-tail wrapper for the `Common_DeleteGoalAccountAllocation` GraphQL operation.
 *
 ...
 */
object DeleteGoalAccountAllocation : LongTailOperation("Common_DeleteGoalAccountAllocation")
