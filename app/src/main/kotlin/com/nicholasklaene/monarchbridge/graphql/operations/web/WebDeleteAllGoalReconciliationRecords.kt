...
/**
 * Web bundle screen-aggregate `Web_DeleteAllGoalReconciliationRecords` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDeleteAllGoalReconciliationRecords : MonarchOperation<WebDeleteAllGoalReconciliationRecords.Input, Map<String, Any>> {
    override val operationName: String = "Web_DeleteAllGoalReconciliationRecords"
