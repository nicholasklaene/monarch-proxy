...
/**
 * Monarch `Web_UnclaimBillItem` op wired as an opaque FreeForm pass-through. The
 ...
 */
object UnclaimBillItem : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_UnclaimBillItem"
