...
/**
 * Monarch `Web_ForecastUpdateUserFinancialProfile` op wired as an opaque FreeForm pass-through. The
 * deep response tree is intentionally untyped (Map<String, Any>) because the
 * `Forecast` feature surface churns across Monarch releases; modeling each leaf
 ...
 */
object ForecastUpdateUserFinancialProfile : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_ForecastUpdateUserFinancialProfile"
