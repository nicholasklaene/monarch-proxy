...
/**
 * Web bundle screen-aggregate `Web_GetDiscordConnectionRedirectUrl` (query). Wired as opaque pass-through:
 ...
 */
object WebGetDiscordConnectionRedirectUrl : MonarchOperation<WebGetDiscordConnectionRedirectUrl.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetDiscordConnectionRedirectUrl"
