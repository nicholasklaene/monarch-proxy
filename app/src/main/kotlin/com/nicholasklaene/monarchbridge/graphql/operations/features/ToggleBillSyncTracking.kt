...
/**
 * Monarch `Common_ToggleBillSyncTracking` op wired as an opaque FreeForm pass-through. The
 ...
 */
object ToggleBillSyncTracking : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_ToggleBillSyncTracking"
