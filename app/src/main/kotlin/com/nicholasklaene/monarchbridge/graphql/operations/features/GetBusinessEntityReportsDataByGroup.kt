...
/**
 * Monarch `Common_GetBusinessEntityReportsDataByGroup` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetBusinessEntityReportsDataByGroup : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_GetBusinessEntityReportsDataByGroup"
