...
/**
 * Long-tail wrapper for the `Common_ForceRefreshAccountQuery` GraphQL operation.
 *
 ...
 */
object ForceRefreshAccountQuery : LongTailOperation("Common_ForceRefreshAccountQuery")
