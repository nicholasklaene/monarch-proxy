...
/**
 * Monarch `Web_GetReportConfigurationsForCommandPalette` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetReportConfigurationsForCommandPalette : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_GetReportConfigurationsForCommandPalette"
