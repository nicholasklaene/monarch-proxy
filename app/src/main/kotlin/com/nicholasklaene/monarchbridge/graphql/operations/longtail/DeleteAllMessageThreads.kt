...
/**
 * Long-tail wrapper for the `Common_DeleteAllMessageThreads` GraphQL operation.
 *
 ...
 */
object DeleteAllMessageThreads : LongTailOperation("Common_DeleteAllMessageThreads")
