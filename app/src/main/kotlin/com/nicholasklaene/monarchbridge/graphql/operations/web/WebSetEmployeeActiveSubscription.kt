...
/**
 * Web bundle screen-aggregate `Web_SetEmployeeActiveSubscription` (mutation). Wired as opaque pass-through:
 ...
 */
object WebSetEmployeeActiveSubscription : MonarchOperation<WebSetEmployeeActiveSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_SetEmployeeActiveSubscription"
