...
/**
 * Web bundle screen-aggregate `Web_AccountEditModal` (query). Wired as opaque pass-through:
 ...
 */
object WebAccountEditModal : MonarchOperation<WebAccountEditModal.Input, Map<String, Any>> {
    override val operationName: String = "Web_AccountEditModal"
