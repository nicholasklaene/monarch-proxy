...
/**
 * Monarch `Common_DeleteBusinessEntityLogo` op wired as an opaque FreeForm pass-through. The
 ...
 */
object DeleteBusinessEntityLogo : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_DeleteBusinessEntityLogo"
