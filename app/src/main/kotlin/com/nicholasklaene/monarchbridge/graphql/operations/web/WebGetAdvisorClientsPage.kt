...
/**
 * Web bundle screen-aggregate `Web_GetAdvisorClientsPage` (query). Wired as opaque pass-through:
 ...
 */
object WebGetAdvisorClientsPage : MonarchOperation<WebGetAdvisorClientsPage.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetAdvisorClientsPage"
