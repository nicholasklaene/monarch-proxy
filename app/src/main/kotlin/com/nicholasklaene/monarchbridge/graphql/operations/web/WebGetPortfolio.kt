...
/**
 * Web bundle screen-aggregate `Web_GetPortfolio` (query). Wired as opaque pass-through:
 ...
 */
object WebGetPortfolio : MonarchOperation<WebGetPortfolio.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetPortfolio"
