...
/**
 * Long-tail wrapper for the `Common_SetUserOnboardingFinancialGoals` GraphQL operation.
 *
 ...
 */
object SetUserOnboardingFinancialGoals : LongTailOperation("Common_SetUserOnboardingFinancialGoals")
