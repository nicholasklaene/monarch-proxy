...
/**
 * Web bundle screen-aggregate `Web_CreateZillowAccount` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateZillowAccount : MonarchOperation<WebCreateZillowAccount.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreateZillowAccount"
