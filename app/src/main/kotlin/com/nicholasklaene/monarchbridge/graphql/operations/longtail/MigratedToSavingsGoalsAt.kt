...
/**
 * Long-tail wrapper for the `Common_MigratedToSavingsGoalsAt` GraphQL operation.
 *
 ...
 */
object MigratedToSavingsGoalsAt : LongTailOperation("Common_MigratedToSavingsGoalsAt")
