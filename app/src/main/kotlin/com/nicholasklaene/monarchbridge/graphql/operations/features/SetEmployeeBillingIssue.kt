...
/**
 * Monarch `Web_SetEmployeeBillingIssue` op wired as an opaque FreeForm pass-through. The
 ...
 */
object SetEmployeeBillingIssue : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_SetEmployeeBillingIssue"
