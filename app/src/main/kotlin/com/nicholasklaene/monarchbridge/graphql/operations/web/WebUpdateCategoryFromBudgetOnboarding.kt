...
/**
 * Web bundle screen-aggregate `Web_UpdateCategoryFromBudgetOnboarding` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateCategoryFromBudgetOnboarding : MonarchOperation<WebUpdateCategoryFromBudgetOnboarding.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateCategoryFromBudgetOnboarding"
