...
/**
 * Web bundle screen-aggregate `Web_GetSubscriptionModal` (query). Wired as opaque pass-through:
 ...
 */
object WebGetSubscriptionModal : MonarchOperation<WebGetSubscriptionModal.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetSubscriptionModal"
