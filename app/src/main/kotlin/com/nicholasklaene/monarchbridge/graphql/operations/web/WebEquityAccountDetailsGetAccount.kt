...
/**
 * Web bundle screen-aggregate `Web_EquityAccountDetails_getAccount` (query). Wired as opaque pass-through:
 ...
 */
object WebEquityAccountDetailsGetAccount : MonarchOperation<WebEquityAccountDetailsGetAccount.Input, Map<String, Any>> {
    override val operationName: String = "Web_EquityAccountDetails_getAccount"
