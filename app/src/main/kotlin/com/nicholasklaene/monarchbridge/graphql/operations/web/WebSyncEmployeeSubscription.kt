...
/**
 * Web bundle screen-aggregate `Web_SyncEmployeeSubscription` (mutation). Wired as opaque pass-through:
 ...
 */
object WebSyncEmployeeSubscription : MonarchOperation<WebSyncEmployeeSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_SyncEmployeeSubscription"
