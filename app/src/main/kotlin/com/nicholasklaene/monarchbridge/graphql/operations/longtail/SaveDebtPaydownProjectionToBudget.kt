...
/**
 * Long-tail wrapper for the `Common_SaveDebtPaydownProjectionToBudget` GraphQL operation.
 *
 ...
 */
object SaveDebtPaydownProjectionToBudget : LongTailOperation("Common_SaveDebtPaydownProjectionToBudget")
