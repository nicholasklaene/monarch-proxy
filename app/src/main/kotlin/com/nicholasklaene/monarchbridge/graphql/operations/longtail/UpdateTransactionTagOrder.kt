...
/**
 * Long-tail wrapper for the `Common_UpdateTransactionTagOrder` GraphQL operation.
 *
 ...
 */
object UpdateTransactionTagOrder : LongTailOperation("Common_UpdateTransactionTagOrder")
