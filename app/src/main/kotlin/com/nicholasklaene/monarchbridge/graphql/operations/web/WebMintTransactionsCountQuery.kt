...
/**
 * Web bundle screen-aggregate `Web_MintTransactionsCountQuery` (query). Wired as opaque pass-through:
 ...
 */
object WebMintTransactionsCountQuery : MonarchOperation<WebMintTransactionsCountQuery.Input, Map<String, Any>> {
    override val operationName: String = "Web_MintTransactionsCountQuery"
