...
/**
 * Long-tail wrapper for the `Common_CreateGoalAccountAllocation` GraphQL operation.
 *
 ...
 */
object CreateGoalAccountAllocation : LongTailOperation("Common_CreateGoalAccountAllocation")
