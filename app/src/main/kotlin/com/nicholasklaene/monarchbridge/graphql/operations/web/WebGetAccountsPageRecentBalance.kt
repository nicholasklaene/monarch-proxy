...
/**
 * Web bundle screen-aggregate `Web_GetAccountsPageRecentBalance` (query). Wired as opaque pass-through:
 ...
 */
object WebGetAccountsPageRecentBalance : MonarchOperation<WebGetAccountsPageRecentBalance.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetAccountsPageRecentBalance"
