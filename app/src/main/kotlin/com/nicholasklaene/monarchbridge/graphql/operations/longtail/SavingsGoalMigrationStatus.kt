...
/**
 * Long-tail wrapper for the `Common_SavingsGoalMigrationStatus` GraphQL operation.
 *
 ...
 */
object SavingsGoalMigrationStatus : LongTailOperation("Common_SavingsGoalMigrationStatus")
