...
/**
 * Web bundle screen-aggregate `Web_ReviewStream` (mutation). Wired as opaque pass-through:
 ...
 */
object WebReviewStream : MonarchOperation<WebReviewStream.Input, Map<String, Any>> {
    override val operationName: String = "Web_ReviewStream"
