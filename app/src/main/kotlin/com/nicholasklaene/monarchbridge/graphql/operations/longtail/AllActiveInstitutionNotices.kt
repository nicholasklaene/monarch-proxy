...
/**
 * Long-tail wrapper for the `Common_AllActiveInstitutionNotices` GraphQL operation.
 *
 ...
 */
object AllActiveInstitutionNotices : LongTailOperation("Common_AllActiveInstitutionNotices")
