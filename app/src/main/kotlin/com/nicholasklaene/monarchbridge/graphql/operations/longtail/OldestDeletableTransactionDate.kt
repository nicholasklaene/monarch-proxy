...
/**
 * Long-tail wrapper for the `Common_OldestDeletableTransactionDate` GraphQL operation.
 *
 ...
 */
object OldestDeletableTransactionDate : LongTailOperation("Common_OldestDeletableTransactionDate")
