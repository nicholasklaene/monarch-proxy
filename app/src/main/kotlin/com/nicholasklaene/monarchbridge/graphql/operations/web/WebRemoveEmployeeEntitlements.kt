...
/**
 * Web bundle screen-aggregate `Web_RemoveEmployeeEntitlements` (mutation). Wired as opaque pass-through:
 ...
 */
object WebRemoveEmployeeEntitlements : MonarchOperation<WebRemoveEmployeeEntitlements.Input, Map<String, Any>> {
    override val operationName: String = "Web_RemoveEmployeeEntitlements"
