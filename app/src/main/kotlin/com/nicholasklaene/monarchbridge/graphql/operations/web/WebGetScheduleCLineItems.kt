...
/**
 * Web bundle screen-aggregate `Web_GetScheduleCLineItems` (query). Wired as opaque pass-through:
 ...
 */
object WebGetScheduleCLineItems : MonarchOperation<WebGetScheduleCLineItems.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetScheduleCLineItems"
