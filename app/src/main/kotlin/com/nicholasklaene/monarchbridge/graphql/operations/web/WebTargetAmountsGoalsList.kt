...
/**
 * Web bundle screen-aggregate `Web_TargetAmountsGoalsList` (query). Wired as opaque pass-through:
 ...
 */
object WebTargetAmountsGoalsList : MonarchOperation<WebTargetAmountsGoalsList.Input, Map<String, Any>> {
    override val operationName: String = "Web_TargetAmountsGoalsList"
