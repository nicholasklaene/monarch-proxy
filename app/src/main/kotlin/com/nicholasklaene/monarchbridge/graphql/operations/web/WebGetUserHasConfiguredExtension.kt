...
/**
 * Web bundle screen-aggregate `Web_GetUserHasConfiguredExtension` (query). Wired as opaque pass-through:
 ...
 */
object WebGetUserHasConfiguredExtension : MonarchOperation<WebGetUserHasConfiguredExtension.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetUserHasConfiguredExtension"
