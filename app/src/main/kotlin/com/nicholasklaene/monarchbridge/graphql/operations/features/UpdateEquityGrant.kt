...
/**
 * Monarch `Web_UpdateEquityGrant` op wired as an opaque FreeForm pass-through. The
 ...
 */
object UpdateEquityGrant : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_UpdateEquityGrant"
