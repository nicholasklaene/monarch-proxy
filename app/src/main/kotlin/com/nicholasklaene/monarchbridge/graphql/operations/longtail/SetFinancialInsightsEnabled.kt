...
/**
 * Long-tail wrapper for the `Common_SetFinancialInsightsEnabled` GraphQL operation.
 *
 ...
 */
object SetFinancialInsightsEnabled : LongTailOperation("Common_SetFinancialInsightsEnabled")
