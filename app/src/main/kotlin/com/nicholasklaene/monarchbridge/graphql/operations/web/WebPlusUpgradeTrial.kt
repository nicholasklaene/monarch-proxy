...
/**
 * Web bundle screen-aggregate `Web_PlusUpgradeTrial` (query). Wired as opaque pass-through:
 ...
 */
object WebPlusUpgradeTrial : MonarchOperation<WebPlusUpgradeTrial.Input, Map<String, Any>> {
    override val operationName: String = "Web_PlusUpgradeTrial"
