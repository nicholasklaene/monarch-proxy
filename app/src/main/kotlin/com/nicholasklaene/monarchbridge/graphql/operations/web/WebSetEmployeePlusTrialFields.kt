...
/**
 * Web bundle screen-aggregate `Web_SetEmployeePlusTrialFields` (mutation). Wired as opaque pass-through:
 ...
 */
object WebSetEmployeePlusTrialFields : MonarchOperation<WebSetEmployeePlusTrialFields.Input, Map<String, Any>> {
    override val operationName: String = "Web_SetEmployeePlusTrialFields"
