...
/**
 * Web bundle screen-aggregate `Web_UpdateTransactionOverview` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateTransactionOverview : MonarchOperation<WebUpdateTransactionOverview.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateTransactionOverview"
