...
/**
 * Monarch `Web_ReplaceForecastEvents` op wired as an opaque FreeForm pass-through. The
 ...
 */
object ReplaceForecastEvents : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_ReplaceForecastEvents"
