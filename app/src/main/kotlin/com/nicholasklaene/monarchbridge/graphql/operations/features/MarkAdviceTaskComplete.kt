...
/**
 * Monarch `Web_MarkAdviceTaskComplete` op wired as an opaque FreeForm pass-through. The
 ...
 */
object MarkAdviceTaskComplete : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_MarkAdviceTaskComplete"
