...
/**
 * Monarch `Common_CreateReportConfiguration` op wired as an opaque FreeForm pass-through. The
 ...
 */
object CreateReportConfiguration : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_CreateReportConfiguration"
