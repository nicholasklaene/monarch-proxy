...
/**
 * Web bundle screen-aggregate `Web_CreateAdvisorSubscription` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateAdvisorSubscription : MonarchOperation<WebCreateAdvisorSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreateAdvisorSubscription"
