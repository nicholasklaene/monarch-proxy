...
/**
 * Monarch `Web_AvailableBusinessEntityDemoScenarios` op wired as an opaque FreeForm pass-through. The
 ...
 */
object AvailableBusinessEntityDemoScenarios : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_AvailableBusinessEntityDemoScenarios"
