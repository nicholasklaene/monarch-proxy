...
/**
 * Monarch `Web_ClaimBillItem` op wired as an opaque FreeForm pass-through. The
 ...
 */
object ClaimBillItem : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_ClaimBillItem"
