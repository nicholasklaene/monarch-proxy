...
/**
 * Long-tail wrapper for the `Common_GetPlanOnboardingState` GraphQL operation.
 *
 ...
 */
object GetPlanOnboardingState : LongTailOperation("Common_GetPlanOnboardingState")
