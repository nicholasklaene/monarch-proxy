...
/**
 * Long-tail wrapper for the `GetMobileSubscriptionOffering` GraphQL operation.
 *
 ...
 */
object GetMobileSubscriptionOffering : LongTailOperation("GetMobileSubscriptionOffering")
