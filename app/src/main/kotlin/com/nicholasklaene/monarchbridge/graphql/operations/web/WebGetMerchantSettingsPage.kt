...
/**
 * Web bundle screen-aggregate `Web_GetMerchantSettingsPage` (query). Wired as opaque pass-through:
 ...
 */
object WebGetMerchantSettingsPage : MonarchOperation<WebGetMerchantSettingsPage.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetMerchantSettingsPage"
