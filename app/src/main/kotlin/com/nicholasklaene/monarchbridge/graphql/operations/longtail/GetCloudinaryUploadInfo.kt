...
/**
 * Long-tail wrapper for the `Common_GetCloudinaryUploadInfo` GraphQL operation.
 *
 ...
 */
object GetCloudinaryUploadInfo : LongTailOperation("Common_GetCloudinaryUploadInfo")
