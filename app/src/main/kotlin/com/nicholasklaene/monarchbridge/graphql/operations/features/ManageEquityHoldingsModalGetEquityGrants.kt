...
/**
 * Monarch `Web_ManageEquityHoldingsModal_GetEquityGrants` op wired as an opaque FreeForm pass-through. The
 * deep response tree is intentionally untyped (Map<String, Any>) because the
 * `EquityGrants` feature surface churns across Monarch releases; modeling each leaf
 ...
 */
object ManageEquityHoldingsModalGetEquityGrants : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_ManageEquityHoldingsModal_GetEquityGrants"
