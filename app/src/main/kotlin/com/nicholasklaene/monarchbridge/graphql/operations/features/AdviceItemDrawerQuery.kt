...
/**
 * Monarch `AdviceItemDrawerQuery_Web` op wired as an opaque FreeForm pass-through. The
 ...
 */
object AdviceItemDrawerQuery : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "AdviceItemDrawerQuery_Web"
