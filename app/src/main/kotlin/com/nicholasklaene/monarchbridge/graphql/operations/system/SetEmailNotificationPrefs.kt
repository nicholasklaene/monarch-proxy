...
/** Patch any subset of the email-channel toggles. Returns the same envelope shape as GetEmailNotificationPrefs (generator dedupes). */
object SetEmailNotificationPrefs :
    MonarchOperation<SetEmailNotificationPrefs.Input, GetEmailNotificationPrefsResponseData> {
    override val operationName: String = "Common_SetEmailNotificationPrefs"
    ...
    override fun parseOutput(data: JsonNode): GetEmailNotificationPrefsResponseData {
        val node = data.path("setEmailNotificationPreferences").path("preferences")
