...
/**
 * Long-tail wrapper for the `Common_SetHasSkippedPremiumUpsell` GraphQL operation.
 *
 ...
 */
object SetHasSkippedPremiumUpsell : LongTailOperation("Common_SetHasSkippedPremiumUpsell")
