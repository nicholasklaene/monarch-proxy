...
/**
 * Long-tail wrapper for the `Common_UpdateGoalAccountAllocation` GraphQL operation.
 *
 ...
 */
object UpdateGoalAccountAllocation : LongTailOperation("Common_UpdateGoalAccountAllocation")
