...
/**
 * Web bundle screen-aggregate `Web_GoalsMonthlyBudgets` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalsMonthlyBudgets : MonarchOperation<WebGoalsMonthlyBudgets.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalsMonthlyBudgets"
