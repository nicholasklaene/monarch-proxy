...
/**
 * Web bundle screen-aggregate `Web_PreviewAccountDataTransferTransactions` (query). Wired as opaque pass-through:
 ...
 */
object WebPreviewAccountDataTransferTransactions : MonarchOperation<WebPreviewAccountDataTransferTransactions.Input, Map<String, Any>> {
    override val operationName: String = "Web_PreviewAccountDataTransferTransactions"
