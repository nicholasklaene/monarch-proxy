...
/**
 * Long-tail wrapper for the `Common_UpdateSavingsGoalAccountLink` GraphQL operation.
 *
 ...
 */
object UpdateSavingsGoalAccountLink : LongTailOperation("Common_UpdateSavingsGoalAccountLink")
