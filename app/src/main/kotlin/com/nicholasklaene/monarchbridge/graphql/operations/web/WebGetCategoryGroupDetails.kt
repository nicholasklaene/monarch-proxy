...
/**
 * Web bundle screen-aggregate `Web_GetCategoryGroupDetails` (query). Wired as opaque pass-through:
 ...
 */
object WebGetCategoryGroupDetails : MonarchOperation<WebGetCategoryGroupDetails.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetCategoryGroupDetails"
