...
/**
 * Long-tail wrapper for the `Common_CreateBudgetForHousehold` GraphQL operation.
 *
 ...
 */
object CreateBudgetForHousehold : LongTailOperation("Common_CreateBudgetForHousehold")
