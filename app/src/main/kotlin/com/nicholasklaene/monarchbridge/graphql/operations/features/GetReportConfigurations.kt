...
/**
 * Monarch `Common_GetReportConfigurations` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetReportConfigurations : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_GetReportConfigurations"
