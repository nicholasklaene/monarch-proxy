...
/**
 * Web bundle screen-aggregate `Web_UpdateCategoryGroupOrder` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateCategoryGroupOrder : MonarchOperation<WebUpdateCategoryGroupOrder.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateCategoryGroupOrder"
