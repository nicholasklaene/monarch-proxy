...
/**
 * Long-tail wrapper for the `Common_ForceRefreshAccountMutation` GraphQL operation.
 *
 ...
 */
object ForceRefreshAccountMutation : LongTailOperation("Common_ForceRefreshAccountMutation")
