...
/**
 * Web bundle screen-aggregate `Web_GetCategorySelectOptions` (query). Wired as opaque pass-through:
 ...
 */
object WebGetCategorySelectOptions : MonarchOperation<WebGetCategorySelectOptions.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetCategorySelectOptions"
