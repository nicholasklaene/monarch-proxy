...
/**
 * Monarch `Web_ForecastScenarios` op wired as an opaque FreeForm pass-through. The
 ...
 */
object ForecastScenarios : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_ForecastScenarios"
