...
/**
 * Web bundle screen-aggregate `Web_GoalsV2` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalsV2 : MonarchOperation<WebGoalsV2.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalsV2"
