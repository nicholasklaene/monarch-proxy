...
/**
 * Long-tail wrapper for the `Common_RecurringUpdateLiabilityStatement` GraphQL operation.
 *
 ...
 */
object RecurringUpdateLiabilityStatement : LongTailOperation("Common_RecurringUpdateLiabilityStatement")
