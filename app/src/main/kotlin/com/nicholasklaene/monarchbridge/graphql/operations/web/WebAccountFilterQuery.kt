...
/**
 * Web bundle screen-aggregate `Web_AccountFilterQuery` (query). Wired as opaque pass-through:
 ...
 */
object WebAccountFilterQuery : MonarchOperation<WebAccountFilterQuery.Input, Map<String, Any>> {
    override val operationName: String = "Web_AccountFilterQuery"
