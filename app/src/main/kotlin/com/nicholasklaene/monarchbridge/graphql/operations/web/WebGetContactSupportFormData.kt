...
/**
 * Web bundle screen-aggregate `Web_GetContactSupportFormData` (query). Wired as opaque pass-through:
 ...
 */
object WebGetContactSupportFormData : MonarchOperation<WebGetContactSupportFormData.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetContactSupportFormData"
