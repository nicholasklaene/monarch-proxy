...
/**
 * Web bundle screen-aggregate `Web_CreateAIReport` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateAIReport : MonarchOperation<WebCreateAIReport.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreateAIReport"
