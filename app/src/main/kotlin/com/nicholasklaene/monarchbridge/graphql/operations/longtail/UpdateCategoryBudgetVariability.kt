...
/**
 * Long-tail wrapper for the `Common_UpdateCategoryBudgetVariability` GraphQL operation.
 *
 ...
 */
object UpdateCategoryBudgetVariability : LongTailOperation("Common_UpdateCategoryBudgetVariability")
