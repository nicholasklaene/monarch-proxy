...
/**
 * Web bundle screen-aggregate `Web_SearchSecurities` (query). Wired as opaque pass-through:
 ...
 */
object WebSearchSecurities : MonarchOperation<WebSearchSecurities.Input, Map<String, Any>> {
    override val operationName: String = "Web_SearchSecurities"
