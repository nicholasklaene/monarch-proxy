...
/**
 * Web bundle screen-aggregate `Web_GetMerchantSelectRecommendedMerchants` (query). Wired as opaque pass-through:
 ...
 */
object WebGetMerchantSelectRecommendedMerchants : MonarchOperation<WebGetMerchantSelectRecommendedMerchants.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetMerchantSelectRecommendedMerchants"
