...
/**
 * Web bundle screen-aggregate `Web_GetCategorizationDetails` (query). Wired as opaque pass-through:
 ...
 */
object WebGetCategorizationDetails : MonarchOperation<WebGetCategorizationDetails.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetCategorizationDetails"
