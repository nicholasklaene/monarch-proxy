...
/**
 * Web bundle screen-aggregate `Web_StartDownloadScheduleCSession` (mutation). Wired as opaque pass-through:
 ...
 */
object WebStartDownloadScheduleCSession : MonarchOperation<WebStartDownloadScheduleCSession.Input, Map<String, Any>> {
    override val operationName: String = "Web_StartDownloadScheduleCSession"
