...
/**
 * Web bundle screen-aggregate `Web_UpdateOrCreateStripePaymentMethod` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateOrCreateStripePaymentMethod : MonarchOperation<WebUpdateOrCreateStripePaymentMethod.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateOrCreateStripePaymentMethod"
