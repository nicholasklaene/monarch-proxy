...
/**
 * Monarch `AdviceTaskDrawerQuery_Web` op wired as an opaque FreeForm pass-through. The
 ...
 */
object AdviceTaskDrawerQuery : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "AdviceTaskDrawerQuery_Web"
