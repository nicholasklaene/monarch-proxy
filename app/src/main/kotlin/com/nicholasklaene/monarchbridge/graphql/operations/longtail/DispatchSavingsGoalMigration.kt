...
/**
 * Long-tail wrapper for the `Common_DispatchSavingsGoalMigration` GraphQL operation.
 *
 ...
 */
object DispatchSavingsGoalMigration : LongTailOperation("Common_DispatchSavingsGoalMigration")
