...
/**
 * Web bundle screen-aggregate `Web_TestCreditScoreChangedNotification` (mutation). Wired as opaque pass-through:
 ...
 */
object WebTestCreditScoreChangedNotification : MonarchOperation<WebTestCreditScoreChangedNotification.Input, Map<String, Any>> {
    override val operationName: String = "Web_TestCreditScoreChangedNotification"
