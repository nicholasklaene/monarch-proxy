...
/**
 * Web bundle screen-aggregate `Web_SetEmployeeExpiredTrial` (mutation). Wired as opaque pass-through:
 ...
 */
object WebSetEmployeeExpiredTrial : MonarchOperation<WebSetEmployeeExpiredTrial.Input, Map<String, Any>> {
    override val operationName: String = "Web_SetEmployeeExpiredTrial"
