...
/**
 * Long-tail wrapper for the `Common_RevokeInviteToHousehold` GraphQL operation.
 *
 ...
 */
object RevokeInviteToHousehold : LongTailOperation("Common_RevokeInviteToHousehold")
