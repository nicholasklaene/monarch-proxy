...
/**
 * Web bundle screen-aggregate `Web_SearchInstitutionsQuery` (query). Wired as opaque pass-through:
 ...
 */
object WebSearchInstitutionsQuery : MonarchOperation<WebSearchInstitutionsQuery.Input, Map<String, Any>> {
    override val operationName: String = "Web_SearchInstitutionsQuery"
