...
/**
 * Web bundle screen-aggregate `Web_UpdateUserFinancialProfile` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateUserFinancialProfile : MonarchOperation<WebUpdateUserFinancialProfile.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateUserFinancialProfile"
