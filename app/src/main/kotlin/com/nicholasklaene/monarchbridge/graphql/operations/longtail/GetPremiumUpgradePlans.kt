...
/**
 * Long-tail wrapper for the `Common_GetPremiumUpgradePlans` GraphQL operation.
 *
 ...
 */
object GetPremiumUpgradePlans : LongTailOperation("Common_GetPremiumUpgradePlans")
