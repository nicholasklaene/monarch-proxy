...
/**
 * Web bundle screen-aggregate `Web_CreateEquityAccountWithGrants` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateEquityAccountWithGrants : MonarchOperation<WebCreateEquityAccountWithGrants.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreateEquityAccountWithGrants"
