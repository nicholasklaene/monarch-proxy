...
/**
 * Web bundle screen-aggregate `Web_ReactivateSubscription` (mutation). Wired as opaque pass-through:
 ...
 */
object WebReactivateSubscription : MonarchOperation<WebReactivateSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_ReactivateSubscription"
