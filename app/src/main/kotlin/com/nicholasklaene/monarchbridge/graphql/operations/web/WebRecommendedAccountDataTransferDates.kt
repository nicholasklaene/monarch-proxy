...
/**
 * Web bundle screen-aggregate `Web_RecommendedAccountDataTransferDates` (query). Wired as opaque pass-through:
 ...
 */
object WebRecommendedAccountDataTransferDates : MonarchOperation<WebRecommendedAccountDataTransferDates.Input, Map<String, Any>> {
    override val operationName: String = "Web_RecommendedAccountDataTransferDates"
