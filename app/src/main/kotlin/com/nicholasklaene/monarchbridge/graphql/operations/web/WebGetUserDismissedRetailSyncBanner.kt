...
/**
 * Web bundle screen-aggregate `Web_GetUserDismissedRetailSyncBanner` (query). Wired as opaque pass-through:
 ...
 */
object WebGetUserDismissedRetailSyncBanner : MonarchOperation<WebGetUserDismissedRetailSyncBanner.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetUserDismissedRetailSyncBanner"
