...
/**
 * Monarch `AdviceQuery_Web` op wired as an opaque FreeForm pass-through. The
 ...
 */
object AdviceQuery : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "AdviceQuery_Web"
