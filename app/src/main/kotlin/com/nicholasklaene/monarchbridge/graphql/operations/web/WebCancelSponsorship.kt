...
/**
 * Web bundle screen-aggregate `Web_CancelSponsorship` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCancelSponsorship : MonarchOperation<WebCancelSponsorship.Input, Map<String, Any>> {
    override val operationName: String = "Web_CancelSponsorship"
