...
/**
 * Web bundle screen-aggregate `Web_BudgetOnboardingGetAccounts` (query). Wired as opaque pass-through:
 ...
 */
object WebBudgetOnboardingGetAccounts : MonarchOperation<WebBudgetOnboardingGetAccounts.Input, Map<String, Any>> {
    override val operationName: String = "Web_BudgetOnboardingGetAccounts"
