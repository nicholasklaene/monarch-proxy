...
/**
 * Web bundle screen-aggregate `Web_DisableMfa` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDisableMfa : MonarchOperation<WebDisableMfa.Input, Map<String, Any>> {
    override val operationName: String = "Web_DisableMfa"
