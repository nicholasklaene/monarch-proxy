...
/**
 * Mobile screen-aggregate mutation wired as an opaque FreeForm pass-through. The
 ...
 */
object ResetHouseholdRecurringMerchantSearch : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Mobile_ResetHouseholdRecurringMerchantSearch"
