...
/**
 * Long-tail wrapper for the `Common_SyncCredentialAfterReconnect` GraphQL operation.
 *
 ...
 */
object SyncCredentialAfterReconnect : LongTailOperation("Common_SyncCredentialAfterReconnect")
