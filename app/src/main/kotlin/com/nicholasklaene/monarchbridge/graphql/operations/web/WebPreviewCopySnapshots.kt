...
/**
 * Web bundle screen-aggregate `Web_PreviewCopySnapshots` (query). Wired as opaque pass-through:
 ...
 */
object WebPreviewCopySnapshots : MonarchOperation<WebPreviewCopySnapshots.Input, Map<String, Any>> {
    override val operationName: String = "Web_PreviewCopySnapshots"
