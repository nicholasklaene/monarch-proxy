...
/**
 * Long-tail wrapper for the `Common_PreviewDeleteTransactions` GraphQL operation.
 *
 ...
 */
object PreviewDeleteTransactions : LongTailOperation("Common_PreviewDeleteTransactions")
