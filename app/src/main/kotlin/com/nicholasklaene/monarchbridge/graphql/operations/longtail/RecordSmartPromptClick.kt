...
/**
 * Long-tail wrapper for the `Common_RecordSmartPromptClick` GraphQL operation.
 *
 ...
 */
object RecordSmartPromptClick : LongTailOperation("Common_RecordSmartPromptClick")
