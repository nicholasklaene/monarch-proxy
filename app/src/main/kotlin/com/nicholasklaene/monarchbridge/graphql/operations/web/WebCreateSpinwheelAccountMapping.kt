...
/**
 * Web bundle screen-aggregate `Web_CreateSpinwheelAccountMapping` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateSpinwheelAccountMapping : MonarchOperation<WebCreateSpinwheelAccountMapping.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreateSpinwheelAccountMapping"
