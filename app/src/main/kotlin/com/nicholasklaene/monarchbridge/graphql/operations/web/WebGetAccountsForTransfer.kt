...
/**
 * Web bundle screen-aggregate `Web_GetAccountsForTransfer` (query). Wired as opaque pass-through:
 ...
 */
object WebGetAccountsForTransfer : MonarchOperation<WebGetAccountsForTransfer.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetAccountsForTransfer"
