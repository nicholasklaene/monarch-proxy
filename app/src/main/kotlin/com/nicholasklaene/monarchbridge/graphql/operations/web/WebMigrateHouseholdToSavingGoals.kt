...
/**
 * Web bundle screen-aggregate `Web_MigrateHouseholdToSavingGoals` (mutation). Wired as opaque pass-through:
 ...
 */
object WebMigrateHouseholdToSavingGoals : MonarchOperation<WebMigrateHouseholdToSavingGoals.Input, Map<String, Any>> {
    override val operationName: String = "Web_MigrateHouseholdToSavingGoals"
