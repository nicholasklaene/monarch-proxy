...
/**
 * Web bundle screen-aggregate `Web_GetConnectedApps` (query). Wired as opaque pass-through:
 ...
 */
object WebGetConnectedApps : MonarchOperation<WebGetConnectedApps.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetConnectedApps"
