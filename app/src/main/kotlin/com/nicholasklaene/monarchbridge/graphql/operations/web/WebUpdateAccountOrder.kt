...
/**
 * Web bundle screen-aggregate `Web_UpdateAccountOrder` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateAccountOrder : MonarchOperation<WebUpdateAccountOrder.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateAccountOrder"
