...
/**
 * Web bundle screen-aggregate `Web_GetTaxPrepUnmappedCategoryTransactions` (query). Wired as opaque pass-through:
 ...
 */
object WebGetTaxPrepUnmappedCategoryTransactions : MonarchOperation<WebGetTaxPrepUnmappedCategoryTransactions.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetTaxPrepUnmappedCategoryTransactions"
