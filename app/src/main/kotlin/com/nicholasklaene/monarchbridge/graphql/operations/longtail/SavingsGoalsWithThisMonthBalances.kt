...
/**
 * Long-tail wrapper for the `Common_SavingsGoalsWithThisMonthBalances` GraphQL operation.
 *
 ...
 */
object SavingsGoalsWithThisMonthBalances : LongTailOperation("Common_SavingsGoalsWithThisMonthBalances")
