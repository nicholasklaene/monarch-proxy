...
/**
 * Long-tail wrapper for the `Common_TransferAccountDataAsync` GraphQL operation.
 *
 ...
 */
object TransferAccountDataAsync : LongTailOperation("Common_TransferAccountDataAsync")
