...
/**
 * Long-tail wrapper for the `Common_UpdateRetailVendorSettings` GraphQL operation.
 *
 ...
 */
object UpdateRetailVendorSettings : LongTailOperation("Common_UpdateRetailVendorSettings")
