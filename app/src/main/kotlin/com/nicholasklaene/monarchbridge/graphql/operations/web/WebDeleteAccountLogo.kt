...
/**
 * Web bundle screen-aggregate `Web_DeleteAccountLogo` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDeleteAccountLogo : MonarchOperation<WebDeleteAccountLogo.Input, Map<String, Any>> {
    override val operationName: String = "Web_DeleteAccountLogo"
