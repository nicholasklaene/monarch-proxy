...
/**
 * Long-tail wrapper for the `Common_ReconcileExternalSpending` GraphQL operation.
 *
 ...
 */
object ReconcileExternalSpending : LongTailOperation("Common_ReconcileExternalSpending")
