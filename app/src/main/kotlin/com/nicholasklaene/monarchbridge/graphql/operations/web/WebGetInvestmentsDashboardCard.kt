...
/**
 * Web bundle screen-aggregate `Web_GetInvestmentsDashboardCard` (query). Wired as opaque pass-through:
 ...
 */
object WebGetInvestmentsDashboardCard : MonarchOperation<WebGetInvestmentsDashboardCard.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetInvestmentsDashboardCard"
