...
/**
 * Monarch `Common_GetBusinessEntityReportsDataByCategory` op wired as an opaque FreeForm pass-through. The
 * deep response tree is intentionally untyped (Map<String, Any>) because the
 * `BusinessEntity` feature surface churns across Monarch releases; modeling each leaf
 ...
 */
object GetBusinessEntityReportsDataByCategory : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Common_GetBusinessEntityReportsDataByCategory"
