...
/**
 * Web bundle screen-aggregate `Web_GoalsDashboardCardV2` (query). Wired as opaque pass-through:
 ...
 */
object WebGoalsDashboardCardV2 : MonarchOperation<WebGoalsDashboardCardV2.Input, Map<String, Any>> {
    override val operationName: String = "Web_GoalsDashboardCardV2"
