...
/**
 * Monarch `Mobile_SignupBillingZip_UpdateBillingPostalCode` op wired as an opaque FreeForm pass-through. The
 * deep response tree is intentionally untyped (Map<String, Any>) because the
 * `Bills` feature surface churns across Monarch releases; modeling each leaf
 ...
 */
object MobileSignupBillingZipUpdatePostalCode : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Mobile_SignupBillingZip_UpdateBillingPostalCode"
