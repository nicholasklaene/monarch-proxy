...
/**
 * Long-tail wrapper for the `GetAggregatesGraphFlexExpense` GraphQL operation.
 *
 ...
 */
object GetAggregatesGraphFlexExpense : LongTailOperation("GetAggregatesGraphFlexExpense")
