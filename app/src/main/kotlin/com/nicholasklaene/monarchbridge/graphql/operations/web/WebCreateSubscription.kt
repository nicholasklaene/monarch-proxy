...
/**
 * Web bundle screen-aggregate `Web_CreateSubscription` (mutation). Wired as opaque pass-through:
 ...
 */
object WebCreateSubscription : MonarchOperation<WebCreateSubscription.Input, Map<String, Any>> {
    override val operationName: String = "Web_CreateSubscription"
