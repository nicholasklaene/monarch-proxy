...
/**
 * Web bundle screen-aggregate `Web_ConvertEmployeeTrial` (mutation). Wired as opaque pass-through:
 ...
 */
object WebConvertEmployeeTrial : MonarchOperation<WebConvertEmployeeTrial.Input, Map<String, Any>> {
    override val operationName: String = "Web_ConvertEmployeeTrial"
