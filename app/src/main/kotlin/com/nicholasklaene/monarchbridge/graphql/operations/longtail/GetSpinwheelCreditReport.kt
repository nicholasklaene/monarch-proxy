...
/**
 * Long-tail wrapper for the `Common_GetSpinwheelCreditReport` GraphQL operation.
 *
 ...
 */
object GetSpinwheelCreditReport : LongTailOperation("Common_GetSpinwheelCreditReport")
