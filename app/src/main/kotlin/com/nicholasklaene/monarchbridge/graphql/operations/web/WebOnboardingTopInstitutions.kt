...
/**
 * Web bundle screen-aggregate `Web_OnboardingTopInstitutions` (query). Wired as opaque pass-through:
 ...
 */
object WebOnboardingTopInstitutions : MonarchOperation<WebOnboardingTopInstitutions.Input, Map<String, Any>> {
    override val operationName: String = "Web_OnboardingTopInstitutions"
