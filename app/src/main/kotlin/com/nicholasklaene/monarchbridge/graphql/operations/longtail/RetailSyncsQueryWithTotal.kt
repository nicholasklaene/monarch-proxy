...
/**
 * Long-tail wrapper for the `Common_RetailSyncsQueryWithTotal` GraphQL operation.
 *
 ...
 */
object RetailSyncsQueryWithTotal : LongTailOperation("Common_RetailSyncsQueryWithTotal")
