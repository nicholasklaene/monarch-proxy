...
/**
 * Web bundle screen-aggregate `Web_UpdateDismissedRetailSyncBanner` (mutation). Wired as opaque pass-through:
 ...
 */
object WebUpdateDismissedRetailSyncBanner : MonarchOperation<WebUpdateDismissedRetailSyncBanner.Input, Map<String, Any>> {
    override val operationName: String = "Web_UpdateDismissedRetailSyncBanner"
