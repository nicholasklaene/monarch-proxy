...
/**
 * Web bundle screen-aggregate `Web_SearchMerchants` (query). Wired as opaque pass-through:
 ...
 */
object WebSearchMerchants : MonarchOperation<WebSearchMerchants.Input, Map<String, Any>> {
    override val operationName: String = "Web_SearchMerchants"
