...
/**
 * Web bundle screen-aggregate `Web_GetStatementParserColumns` (query). Wired as opaque pass-through:
 ...
 */
object WebGetStatementParserColumns : MonarchOperation<WebGetStatementParserColumns.Input, Map<String, Any>> {
    override val operationName: String = "Web_GetStatementParserColumns"
