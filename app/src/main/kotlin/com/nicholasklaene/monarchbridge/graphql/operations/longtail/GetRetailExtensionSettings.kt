...
/**
 * Long-tail wrapper for the `Common_GetRetailExtensionSettings` GraphQL operation.
 *
 ...
 */
object GetRetailExtensionSettings : LongTailOperation("Common_GetRetailExtensionSettings")
