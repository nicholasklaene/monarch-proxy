...
/**
 * Monarch `Web_GetAdvisorBillingPage` op wired as an opaque FreeForm pass-through. The
 ...
 */
object GetAdvisorBillingPage : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_GetAdvisorBillingPage"
