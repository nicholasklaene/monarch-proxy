...
/**
 * Monarch `Web_OnboardingBillingZip_UpdateBillingPostalCode` op wired as an opaque FreeForm pass-through. The
 ...
 */
object OnboardingBillingZipUpdatePostalCode : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Web_OnboardingBillingZip_UpdateBillingPostalCode"
