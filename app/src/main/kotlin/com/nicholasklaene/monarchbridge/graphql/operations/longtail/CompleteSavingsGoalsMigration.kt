...
/**
 * Long-tail wrapper for the `Common_CompleteSavingsGoalsMigration` GraphQL operation.
 *
 ...
 */
object CompleteSavingsGoalsMigration : LongTailOperation("Common_CompleteSavingsGoalsMigration")
