...
/**
 * Web bundle screen-aggregate `Web_DisconnectCredentialMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebDisconnectCredentialMutation : MonarchOperation<WebDisconnectCredentialMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_DisconnectCredentialMutation"
