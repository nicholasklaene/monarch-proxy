...
/**
 * Web bundle screen-aggregate `Web_SetEmployeeSubscriptionEnded` (mutation). Wired as opaque pass-through:
 ...
 */
object WebSetEmployeeSubscriptionEnded : MonarchOperation<WebSetEmployeeSubscriptionEnded.Input, Map<String, Any>> {
    override val operationName: String = "Web_SetEmployeeSubscriptionEnded"
