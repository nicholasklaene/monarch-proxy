...
/**
 * Web bundle screen-aggregate `Web_MoveMoneyMutation` (mutation). Wired as opaque pass-through:
 ...
 */
object WebMoveMoneyMutation : MonarchOperation<WebMoveMoneyMutation.Input, Map<String, Any>> {
    override val operationName: String = "Web_MoveMoneyMutation"
