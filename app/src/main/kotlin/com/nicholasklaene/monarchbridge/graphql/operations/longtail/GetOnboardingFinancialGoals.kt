...
/**
 * Long-tail wrapper for the `Common_GetOnboardingFinancialGoals` GraphQL operation.
 *
 ...
 */
object GetOnboardingFinancialGoals : LongTailOperation("Common_GetOnboardingFinancialGoals")
