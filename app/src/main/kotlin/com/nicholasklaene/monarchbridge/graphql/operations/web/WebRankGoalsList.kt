...
/**
 * Web bundle screen-aggregate `Web_RankGoalsList` (query). Wired as opaque pass-through:
 ...
 */
object WebRankGoalsList : MonarchOperation<WebRankGoalsList.Input, Map<String, Any>> {
    override val operationName: String = "Web_RankGoalsList"
