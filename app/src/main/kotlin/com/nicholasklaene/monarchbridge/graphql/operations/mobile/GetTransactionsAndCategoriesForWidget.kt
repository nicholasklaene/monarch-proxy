 ...
 */
object GetTransactionsAndCategoriesForWidget : MonarchOperation<Unit, Map<String, Any>> {
    override val operationName: String = "Mobile_GetTransactionsAndCategoriesForWidget"
